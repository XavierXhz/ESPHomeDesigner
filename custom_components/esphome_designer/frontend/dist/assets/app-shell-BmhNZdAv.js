...
`,an="esphome-designer-ha-auth";let ln=null;function ft(){try{const t=globalThis.location;return t||null}catch{return null}}function je(){try{return globalThis.localStorage??null}catch{return null}}function dn(t){if(typeof t!="string")return;const e=t.trim();!e||e==="null"||(ln=e)}function Ti(){try{const t=globalThis.name;if(!t)return;const e=JSON.parse(t);e?.type===an&&dn(e.accessToken)}catch{}}function Mi(){Ti();try{globalThis.addEventListener?.("message",t=>{const e=ft();if(e&&t.origin!==e.origin)return;const n=t.data;n?.type===an&&dn(n.accessToken)})}catch{}}function cn(t){if(!t)return null;let e=t.trim();if(!e)return null;try{const n=new URL(e);return n.protocol!=="http:"&&n.protocol!=="https:"?null:(e=`${n.origin}${n.pathname}`,n.search&&(e+=n.search),e.endsWith("/")&&(e=e.slice(0,-1)),e.includes("reterminal_dashboard")&&(e=e.replace("reterminal_dashboard","esphome_designer")),e.includes("/api/")||(e+="/api/esphome_designer"),e)}catch{return null}}function pn(){const t=un();if(t){const e=cn(t);return e?(e!==t.trim()&&(_.log("[Env] Normalizing stored manual HA URL"),hn(e)),e):(_.warn("[Env] Ignoring invalid manually configured HA URL"),null)}try{const e=ft();return!e||e.protocol==="file:"?null:e.hostname==="homeassistant"||e.hostname==="hassio"||e.pathname.includes("/api/")||e.pathname.includes("/local/")||e.pathname.includes("/hacsfiles/")||e.pathname.includes("/esphome-designer")?`${e.origin}/api/esphome_designer`:null}catch{return null}}function un(){try{const t=je();return t?t.getItem("ha_manual_url"):null}catch{return null}}function hn(t){try{const e=je();if(!e)return;if(t){const n=cn(t);if(!n){_.warn("[Env] Refusing to store invalid HA URL");return}e.setItem("ha_manual_url",n)}else e.removeItem("ha_manual_url")}catch(e){_.error("Failed to save HA URL:",e)}}function gn(){try{const t=je();return t?t.getItem("ha_llat_token"):null}catch{return null}}function mn(){return ln||gn()}function Ai(t){try{const e=je();if(!e)return;t?e.setItem("ha_llat_token",t):e.removeItem("ha_llat_token")}catch(e){_.error("Failed to save HA Token:",e)}}let F=pn();Mi();function At(){F=pn()}function N(){return!!F}function it(){try{const t=ft();return!t||t.protocol==="file:"?!1:t.hostname==="homeassistant"||t.hostname==="hassio"||t.pathname.includes("/api/esphome_designer")||t.pathname.includes("/esphome-designer")}catch{return!1}}const Oi="data-esphome-designer-panel-root",Di="data-esphome-designer-overlay-root";function Hi(){return document.querySelector(`[${Oi}]`)||document.body}function Gi(){return document.querySelector(`[${Di}]`)||Hi()}function X(t){return Gi().appendChild(t),t}function Ri(){try{const t=globalThis.parent;return!t||t===globalThis?null:t}catch{return null}}function Bi(){const t=Ri();if(!t)return null;try{const e=t.__ESPHOME_DESIGNER_HASS__;if(e&&typeof e.callApi=="function")return e}catch{}try{const e=t.document?.querySelector?.("esphome-designer-panel")?._hass;if(e&&typeof e.callApi=="function")return e}catch{}try{const e=t.document?.querySelector?.("home-assistant")?.hass;if(e&&typeof e.callApi=="function")return e}catch{}return null}function Wi(t){if(!t)return null;try{decodeURI(t);const e=new URL(t,globalThis.location?.origin||"http://localhost");let n=e.pathname;return n.startsWith("/api/")?n=n.slice(5):n=n.replace(/^\/+/,""),`${n}${e.search}`}catch{return null}}function Ni(t){if(!t)return{};if(t instanceof Headers){const e={};return t.forEach((n,i)=>{e[i]=n}),e}return Array.isArray(t)?Object.fromEntries(t):{...t}}function Fi(t,e){if(t==null)return;if(typeof t!="string")return t;const n=Ni(e),i=n["Content-Type"]||n["content-type"]||"",o=t.trim();if(o){if(i.includes("application/json")||i.includes("text/plain")||o.startsWith("{")||o.startsWith("["))try{return JSON.parse(o)}catch{return t}return t}}function Ot(t,e=200){const n=typeof t=="string"?t:JSON.stringify(t);return{ok:e>=200&&e<300,status:e,json:async()=>t,text:async()=>n,blob:async()=>new Blob([n],{type:"application/json"})}}function zi(t){const e=Number(t?.statusCode??t?.status_code??t?.status);return Number.isFinite(e)&&e>0?e:500}function $i(t){const e=t,n=e?.message||"Request failed",i=e?.body;if(i&&typeof i=="object")return{message:n,...i};if(typeof i=="string")try{const o=JSON.parse(i);return{message:n,...o}}catch{return{error:i,message:n}}return{error:n,message:n}}async function Yi(t,e={}){const n=Bi(),i=Wi(t);if(!n||!i||typeof n.callApi!="function")return null;if(e.signal?.aborted)throw new DOMException("The operation was aborted.","AbortError");try{const o=await n.callApi((e.method||"GET").toLowerCase(),i,Fi(e.body,e.headers));return Ot(o,200)}catch(o){return Ot($i(o),zi(o))}}function A(t,e="info",n=3e3){let i=document.getElementById("toast-container");i||(i=document.createElement("div"),i.id="toast-container",i.style.position="fixed",i.style.bottom="20px",i.style.right="20px",i.style.zIndex="9999",X(i));const o=document.createElement("div");o.className="toast";const r=o.style;e==="error"?r.background="rgba(255, 0, 0, 0.8)":e==="success"?r.background="rgba(0, 128, 0, 0.8)":r.background="rgba(0,0,0,0.8)",o.textContent=t,r.color="white",r.padding="10px 20px",r.borderRadius="4px",r.marginTop="10px",r.opacity="0",r.transition="opacity 0.3s",i.appendChild(o),requestAnimationFrame(()=>{r.opacity="1"}),setTimeout(()=>{r.opacity="0",setTimeout(()=>{o.remove()},300)},n)}async function Ui(){if(!N()){_.warn("Cannot load layout from backend: No HA backend detected.");return}try{let t=null;try{const i=await $(`${F}/layouts`,{headers:z()});if(i.ok){const o=await i.json();_.log("[loadLayoutFromBackend] Available layouts:",o.layouts?.map(r=>r.id)),_.log(`[loadLayoutFromBackend] Last active layout ID from backend: ${o.last_active_layout_id}`),o.last_active_layout_id&&(o.layouts?.some(s=>s.id===o.last_active_layout_id)?(t=o.last_active_layout_id,_.log(`[loadLayoutFromBackend] Loading last active layout: ${t}`)):_.warn(`[loadLayoutFromBackend] Last active layout '${o.last_active_layout_id}' no longer exists`)),!t&&o.layouts&&o.layouts.length>0&&(t=o.layouts[0].id,_.log(`[loadLayoutFromBackend] No valid last active, using first layout: ${t}`))}}catch(i){_.warn("[loadLayoutFromBackend] Could not fetch layouts list:",i)}let e;if(t?e=await $(`${F}/layouts/${t}`,{headers:z()}):e=await $(`${F}/layout`,{headers:z()}),!e.ok)throw new Error(`Failed to load layout: ${e.status}`);const n=await e.json();!n.device_id&&t&&(n.device_id=t),_.log(`[loadLayoutFromBackend] Loaded layout '${n.device_id||t||"default"}':`,{name:n.name,device_model:n.device_model,pages:n.pages?.length,widgets:n.pages?.reduce((i,o)=>i+(o.widgets?.length||0),0),renderingMode:n.renderingMode||n.rendering_mode}),p&&(n.device_id||t)&&p.setCurrentLayoutId(n.device_id||t),typeof ue=="function"?ue(n):_.error("[loadLayoutFromBackend] loadLayoutIntoState function missing!"),P(E.LAYOUT_IMPORTED,n)}catch(t){_.error("Error loading layout from backend:",t),A("Error loading layout from backend","error",5e3)}}let Xe=!1,Ke=!1;async function fn(){if(!N())return!1;if(Xe)return Ke=!0,_.log("[saveLayoutToBackend] Save already in progress, queuing..."),!1;if(!p)throw new Error("AppState not available");const t=p.currentLayoutId||"reterminal_e1001",e=p.settings.device_model||p.deviceModel||"reterminal_e1001",i={...p.getPagesPayload(),device_id:t,name:p.deviceName||"Layout 1",device_model:e,deviceName:p.deviceName||"Layout 1"};Xe=!0,Ke=!1;try{_.log(`[saveLayoutToBackend] Saving to layout '${t}':`,{device_model:e,pages:i.pages?.length,widgets:i.pages?.reduce((a,l)=>a+(l.widgets?.length||0),0),renderingMode:i.renderingMode});const o=new AbortController,r=setTimeout(()=>o.abort(),1e4),s=await $(`${F}/layouts/${t}`,{method:"POST",headers:z(),body:JSON.stringify(i),signal:o.signal});if(clearTimeout(r),!s.ok){const a=await s.json().catch(()=>({}));throw new Error(a.message||a.error||`Save failed: ${s.status}`)}return _.log(`[saveLayoutToBackend] Layout '${t}' saved successfully`),!0}catch(o){const r=o instanceof Error?o:new Error(String(o));if(r.name==="AbortError")return!0;if(r.message.includes("Failed to fetch")||r.message.includes("NetworkError")||r.message.includes("net::ERR_")||r.message.includes("ERR_EMPTY_RESPONSE")||r.message.includes("Load failed"))return!1;throw _.error("Failed to save layout to backend:",r),r}finally{Xe=!1,Ke&&setTimeout(()=>{fn().catch(()=>{})},500)}}async function ji(t){if(!N())throw new Error("No backend");const e=await $(`${F}/import_snippet`,{method:"POST",headers:z(),body:JSON.stringify({yaml:t})});if(!e.ok){const n=await e.json().catch(()=>({}));throw new Error(n.message||n.error||`Import failed with status ${e.status}`)}return await e.json()}let Z=[],Je=!1;function z(){const t={"Content-Type":"application/json"},e=mn();return e&&e.trim()!==""&&e!=="null"&&(t.Authorization=`Bearer ${e}`),t}async function $(t,e={}){const n=await Yi(t,e);return n||fetch(t,e)}const ot="entity-datalist-global";let ae=null;function yn(){return ae||(ae=document.getElementById(ot),ae||(ae=document.createElement("datalist"),ae.id=ot,X(ae))),ae}function Vi(t){const e=yn();e.innerHTML="",!(!t||t.length===0)&&(t.forEach(n=>{const i=document.createElement("option");i.value=n.entity_id,i.label=n.name||n.entity_id,e.appendChild(i)}),_.log(`[EntityDatalist] Updated with ${t.length} entities`))}async function pe(){if(!N()||!F)return[];if(Je)return Z;Je=!0;try{const t=new AbortController,e=setTimeout(()=>t.abort(),1e4);let n,i=!1;const o=mn();n=`${F}/entities?domains=sensor,binary_sensor,weather,light,switch,fan,cover,climate,media_player,input_number,number,input_boolean,input_text,input_select,button,input_button,calendar,person,device_tracker,sun,update,scene`,_.log("[EntityStates] Fetching from:",n);let r;try{r=await $(n,{headers:z(),signal:t.signal})}catch(a){if(o&&F)n=`${F.replace("/api/esphome_designer","")}/api/states`,_.log("[EntityStates] Custom endpoint failed, trying native HA API:",n),i=!0,r=await $(n,{headers:z(),signal:t.signal});else throw a}if(clearTimeout(e),!r.ok)return _.warn("[EntityStates] Failed to fetch:",r.status),[];let s=await r.json();if(i&&Array.isArray(s)){const a=["sensor","binary_sensor","weather","light","switch","fan","cover","climate","media_player","input_number","number","input_boolean","input_text","input_select","button","input_button","calendar","person","device_tracker","sun","update","scene"];s=s.filter(l=>{const c=l.entity_id?.split(".")[0];return a.includes(c)}).map(l=>({entity_id:l.entity_id,name:l.attributes?.friendly_name||l.entity_id,state:l.state,unit:l.attributes?.unit_of_measurement,attributes:l.attributes||{}}))}return Array.isArray(s)?(_.log(`[EntityStates] Received ${s.length} entities`),Z=s.map(a=>{const l=a.unit?`${a.state} ${a.unit}`:a.state;return{entity_id:a.entity_id,domain:a.entity_id?.split(".")?.[0]||"",name:a.name||a.entity_id,state:a.state,unit:a.unit,attributes:a.attributes||{},formatted:l}}),_.log(`[EntityStates] Cached ${Z.length} entity states`),p&&(p.entityStates={},Z.forEach(a=>{p.entityStates[a.entity_id]=a}),_.log(`[EntityStates] Populated AppState.entityStates with ${Object.keys(p.entityStates).length} entries`)),Vi(Z),P(E.ENTITIES_LOADED,Z),Z):(_.warn("[EntityStates] Invalid response format"),[])}catch(t){return t instanceof Error&&t.name==="AbortError"?_.warn("[EntityStates] Request timed out after 10 seconds"):_.warn("[EntityStates] Error fetching:",t),[]}finally{Je=!1}}function aa(t){const e=Z.find(n=>n.entity_id===t);return e?e.attributes??null:null}function qi(t){if(t==null||t==="")return 24*60*60*1e3;if(typeof t=="number")return Math.max(t,0)*1e3;const e=String(t).trim();if(!e)return 24*60*60*1e3;if(/^\d+(?:\.\d+)?$/.test(e))return parseFloat(e)*1e3;const n=e.match(/^(\d+(?:\.\d+)?)([a-z]+)$/i);if(!n)return 24*60*60*1e3;const i=parseFloat(n[1]),o=n[2].toLowerCase();return o.startsWith("s")?i*1e3:o.startsWith("m")?i*60*1e3:o.startsWith("h")?i*60*60*1e3:o.startsWith("d")?i*24*60*60*1e3:o.startsWith("w")?i*7*24*60*60*1e3:i*1e3}function Xi(){return(F||"").replace(/\/api\/esphome_designer$/,"")}function Ki(t){return!Array.isArray(t)||t.length===0?[]:(Array.isArray(t[0])?t[0]:t).filter(n=>n&&typeof n=="object").map(n=>({state:n.state,last_changed:n.last_changed??n.last_updated??null,last_updated:n.last_updated??n.last_changed??null})).filter(n=>n.state!==void 0&&n.state!==null)}let Dt=!1;async function la(t,e="24h"){if(!N()||!F||!t)return[];const n=Xi(),i=new Date,o=new Date(i.getTime()-qi(e)),r=n?`${n}/api/history/period/${encodeURIComponent(o.toISOString())}?filter_entity_id=${encodeURIComponent(t)}&end_time=${encodeURIComponent(i.toISOString())}&minimal_response&no_attributes&significant_changes_only=0`:null;try{if(!r)return[];const s=await $(r,{headers:z()});if(!s.ok){const a=await s.text().catch(()=>"Unknown error");return Dt||(_.log(`[EntityHistory] History fetch failed for ${t}: ${a}`),Dt=!0),[]}return Ki(await s.json())}catch{return[]}}let vn;try{vn=Object.assign({"../../hardware/elecrow-esp32-7inch.yaml":ui,"../../hardware/geekmagic-mini-esp8266.yaml":hi,"../../hardware/guition-esp32-jc4827w543.yaml":gi,"../../hardware/guition-esp32-jc8048w535.yaml":mi,"../../hardware/guition-esp32-jc8048w550.yaml":fi,"../../hardware/guition-esp32-s3-4848s040.yaml":yi,"../../hardware/lilygo-tdisplays3.yaml":vi,"../../hardware/m5stack-tab5.yaml":bi,"../../hardware/seeedstudio-sensecap-indicator.yaml":_i,"../../hardware/sunton-esp32-2432s028.yaml":xi,"../../hardware/sunton-esp32-2432s028R.yaml":Si,"../../hardware/sunton-esp32-4827s032R.yaml":wi,"../../hardware/sunton-esp32-8048s050.yaml":Ei,"../../hardware/sunton-esp32-8048s070.yaml":Ci,"../../hardware/viewdisplay-esp32-s3-uedx48480021.yaml":ki,"../../hardware/waveshare-esp32-s3-touch-lcd-4.3.yaml":Ii,"../../hardware/waveshare-esp32-s3-touch-lcd-7.yaml":Pi,"../../hardware/waveshare-esp32-universal-epaper-7.5v2.yaml":Li})}catch{}const yt={getGlob(){const t=vn;return t?()=>t:void 0},getStorage(){try{return globalThis.localStorage??null}catch{return null}}};async function Ji(){if(N())try{const i=`${F}/hardware/templates`;_.log("[HardwareDiscovery] Fetching from:",i);const o=await $(i,{headers:z(),cache:"no-store"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return(await o.json()).templates||[]}catch(i){_.error("Failed to fetch dynamic hardware templates from HA:",i)}_.log("[HardwareDiscovery] Attempting to load bundled profiles via glob...");const t=[],e=yt.getGlob();if(typeof e!="function")return _.log("[HardwareDiscovery] Bundled profile glob is unavailable in this runtime; relying on backend/localStorage profiles only."),[];const n=e("../../hardware/*.yaml",{query:"?raw",import:"default",eager:!0});for(const i in n)try{const o=n[i],r=i.split("/").pop()||"hardware.yaml",s=bn(o,r);s.id=r.replace(/\.yaml$/i,"").replace(/[^a-z0-9]/gi,"_").toLowerCase(),s.isPackageBased=!0,s.hardwarePackage=`hardware/${r}`,s.isOfflineImport=!1,t.push(s)}catch(o){_.warn(`[HardwareDiscovery] Failed to parse bundled file ${i}:`,o)}return _.log(`[HardwareDiscovery] Loaded ${t.length} bundled fallback profiles.`),t}function bn(t,e){const n="dynamic_offline_"+e.replace(/[^a-z0-9]/gi,"_").toLowerCase();let i=e.replace(/\.yaml$/i,""),o=800,r=480,s="rect";const a=t.match(/#\s*Name:\s*(.*)/i);a&&(i=a[1].trim());const l=t.match(/#\s*Resolution:\s*(\d+)x(\d+)/i);l&&(o=parseInt(l[1]),r=parseInt(l[2]));const c=t.match(/#\s*Shape:\s*(rect|round)/i);c&&(s=c[1].toLowerCase());const u=!!t.match(/#\s*Inverted:\s*(true|yes|1)/i),g=t.match(/^\s*-\s*platform:\s*([a-z0-9_]+)/m)||t.match(/^\s*platform:\s*([a-z0-9_]+)/m),h=g?g[1].trim():void 0,m=t.match(/^\s*model:\s*"?([^"\n]+)"?/m),f=m?m[1].trim():void 0;let y="esp32-s3",b;const v=t.match(/^\s*esp8266:/m);v?y="esp8266":t.match(/^\s*esp32:/m)&&(t.toLowerCase().includes("esp32-s3")?y="esp32-s3":t.toLowerCase().includes("esp32-c3")?y="esp32-c3":t.toLowerCase().includes("esp32-c6")?y="esp32-c6":t.toLowerCase().includes("esp32p4")||t.toLowerCase().includes("esp32-p4")?y="esp32-p4":y="esp32");const x=t.match(/^\s*board:\s*([^\n]+)/m);x&&(b=x[1].trim(),v||(b.toLowerCase().includes("s3")?y="esp32-s3":b.toLowerCase().includes("c3")?y="esp32-c3":b.toLowerCase().includes("c6")?y="esp32-c6":b.toLowerCase().includes("p4")&&(y="esp32-p4")));const w=t.match(/#\s*Chip:\s*(.*)/i);w&&(y=w[1].trim());const k=t.match(/#\s*Board:\s*(.*)/i);k&&(b=k[1].trim());const C=t.match(/^\s*color_palette:\s*(\S+)/m),S=C?C[1].trim():void 0,I=t.match(/^\s*color_order:\s*(\S+)/m),T=I?I[1].trim():void 0,O=t.match(/^\s*update_interval:\s*(\S+)/m),M=O?O[1].trim():void 0,D=t.match(/^\s*invert_colors:\s*(true|false)/mi),B=D?D[1].toLowerCase()==="true":void 0;return{id:n,name:i,resolution:{width:o,height:r},shape:s,chip:y,board:b,displayPlatform:h,displayModel:f,colorPalette:S,colorOrder:T,updateInterval:M,invertColors:B,isPackageBased:!0,isOfflineImport:!0,content:t,features:{psram:t.includes("psram:"),lcd:!t.includes("waveshare_epaper")&&!t.includes("epaper_spi"),lvgl:t.includes("lvgl:")||!t.includes("waveshare_epaper")&&!t.includes("epaper_spi"),epaper:t.includes("waveshare_epaper")||t.includes("epaper_spi"),touch:t.includes("touchscreen:"),inverted_colors:u}}}function Zi(t){const e=yt.getStorage();if(!e){_.warn("No localStorage available for offline profiles.");return}try{const n=JSON.parse(e.getItem("esphome-offline-profiles")||"{}");n[t.id]=t,e.setItem("esphome-offline-profiles",JSON.stringify(n)),_.log("[HardwarePersistence] Saved offline profile to localStorage:",t.id)}catch(n){_.error("Failed to save profile to localStorage:",n)}}function Qi(){const t=yt.getStorage();if(!t)return{};try{return JSON.parse(t.getItem("esphome-offline-profiles")||"{}")}catch(e){return _.warn("Could not load offline profiles from storage:",e),{}}}const H={reterminal_e1001:{name:"Seeedstudio reTerminal E1001 (Monochrome)",displayType:"binary",chip:"esp32-s3",board:"esp32-s3-devkitc-1",displayModel:"7.50inv2p",displayPlatform:"waveshare_epaper",resolution:{width:800,height:480},shape:"rect",psram_mode:"octal",pins:{display:{cs:"GPIO10",dc:"GPIO11",reset:{number:"GPIO12",inverted:!1},busy:{number:"GPIO13",inverted:!0}},i2c:{sda:"GPIO19",scl:"GPIO20"},spi:{clk:"GPIO7",mosi:"GPIO9"},batteryEnable:"GPIO21",batteryAdc:"GPIO1",buzzer:"GPIO45",buttons:{left:"GPIO5",right:"GPIO4",refresh:"GPIO3",home:"GPIO2"}},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15}},features:{psram:!0,buzzer:!0,buttons:!0,sht4x:!0,epaper:!0,inverted_colors:!0}},reterminal_e1002:{name:"Seeedstudio reTerminal E1002 (6-Color)",displayType:"color",displayModel:"Seeed-reTerminal-E1002",displayPlatform:"epaper_spi",resolution:{width:800,height:480},shape:"rect",psram_mode:"octal",pins:{display:{cs:null,dc:null,reset:null,busy:null},i2c:{sda:"GPIO19",scl:"GPIO20"},spi:{clk:"GPIO7",mosi:"GPIO9"},batteryEnable:"GPIO21",batteryAdc:"GPIO1",buzzer:"GPIO45",buttons:{left:"GPIO5",right:"GPIO4",refresh:"GPIO3",home:"GPIO2"}},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15}},features:{psram:!0,buzzer:!0,buttons:!0,sht4x:!0,epaper:!0}},trmnl_diy_esp32s3:{name:"Seeed Studio Trmnl DIY Kit (ESP32-S3)",displayType:"binary",displayModel:"7.50inv2p",displayPlatform:"waveshare_epaper",resolution:{width:800,height:480},shape:"rect",psram_mode:"octal",pins:{display:{cs:"GPIO44",dc:"GPIO10",reset:"GPIO38",busy:{number:"GPIO4",inverted:!0}},i2c:{sda:"GPIO17",scl:"GPIO18"},spi:{clk:"GPIO7",mosi:"GPIO9"},batteryEnable:"GPIO6",batteryAdc:"GPIO1",buzzer:null,buttons:{left:"GPIO2",refresh:"GPIO5"}},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15},curve:[{from:4.15,to:100},{from:3.96,to:90},{from:3.91,to:80},{from:3.85,to:70},{from:3.8,to:60},{from:3.75,to:50},{from:3.68,to:40},{from:3.58,to:30},{from:3.49,to:20},{from:3.41,to:10},{from:3.3,to:5},{from:3.27,to:0}]},features:{psram:!0,buzzer:!1,buttons:!0,sht4x:!1,epaper:!0,inverted_colors:!0}},trmnl:{name:"TRMNL (ESP32-C3)",displayType:"binary",displayModel:"7.50inv2",displayPlatform:"waveshare_epaper",resolution:{width:800,height:480},shape:"rect",pins:{display:{cs:"GPIO6",dc:"GPIO5",reset:{number:"GPIO10",inverted:!1},busy:{number:"GPIO4",inverted:!0}},i2c:{sda:"GPIO1",scl:"GPIO2"},spi:{clk:"GPIO7",mosi:"GPIO8"},batteryEnable:null,batteryAdc:"GPIO3",buzzer:null,buttons:null},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.3,max:4.15}},features:{psram:!1,buzzer:!1,buttons:!1,sht4x:!1,epaper:!0,inverted_colors:!0},chip:"esp32-c3",board:"esp32-c3-devkitm-1"},seeed_xiao_epaper_75:{name:'Seeed Xiao ESP32C3 - 7.5" E-Paper',displayType:"binary",chip:"esp32-c3",board:"seeed_xiao_esp32c3",displayModel:"7.50inv2p",displayPlatform:"waveshare_epaper",resolution:{width:800,height:480},shape:"rect",pins:{display:{cs:"GPIO3",dc:"GPIO5",reset:"GPIO2",busy:{number:"GPIO4",inverted:!0}},spi:{clk:"GPIO8",mosi:"GPIO10"}},features:{psram:!1,buzzer:!1,buttons:!1,epaper:!0,inverted_colors:!0}},esp32_s3_photopainter:{id:"esp32_s3_photopainter",name:"Waveshare PhotoPainter (6-Color)",displayType:"color",displayModel:"7.30in-f",displayPlatform:"waveshare_epaper",resolution:{width:800,height:480},shape:"rect",psram_mode:"octal",pins:{display:{cs:"GPIO9",dc:"GPIO8",reset:"GPIO12",busy:{number:"GPIO13",inverted:!0}},i2c:{sda:"GPIO47",scl:"GPIO48"},spi:{clk:"GPIO10",mosi:"GPIO11"},batteryEnable:null,batteryAdc:null,buzzer:null,buttons:{left:"GPIO0",right:"GPIO4",refresh:null}},battery:{attenuation:"0db",multiplier:1,calibration:{min:3.3,max:4.2}},features:{psram:!0,buzzer:!1,buttons:!0,sht4x:!1,axp2101:!0,manual_pmic:!0,shtc3:!0,epaper:!0},i2c_config:{scan:!1,frequency:"10kHz"}},waveshare_esp32_s3_touch_lcd_7:{name:'Waveshare Touch LCD 7 7.0" 800x480',displayType:"color",isPackageBased:!0,hardwarePackage:"hardware/waveshare-esp32-s3-touch-lcd-7.yaml",resolution:{width:800,height:480},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"gt911",transformed:!0,transform:{swap_xy:!0}}},waveshare_esp32_s3_touch_lcd_4_3:{name:'Waveshare Touch LCD 4.3 4.3" 800x480',displayType:"color",isPackageBased:!0,hardwarePackage:"hardware/waveshare-esp32-s3-touch-lcd-4.3.yaml",resolution:{width:800,height:480},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,touch:!0},touch:{platform:"gt911",transformed:!0,transform:{swap_xy:!0}}},guition_esp32_jc4832w535:{name:'Guition JC4832W535 v3 3.5" 480x320',displayType:"color",chip:"esp32-s3",displayPlatform:"qspi_dbi",displayModel:"JC4832W535",isPackageBased:!0,hardwarePackage:"hardware/guition-esp32-jc8048w535.yaml",resolution:{width:320,height:480},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"axs15231",transformed:!0,transform:{mirror_x:!0,swap_xy:!0},calibration:{x_min:14,x_max:461,y_min:12,y_max:310}}},guition_esp32_jc8048w535:{name:'Guition JC4832W535 v3 3.5" 480x320 (Legacy ID)',displayType:"color",chip:"esp32-s3",displayPlatform:"qspi_dbi",displayModel:"JC4832W535",isPackageBased:!0,isUntestedProfile:!0,hardwarePackage:"hardware/guition-esp32-jc8048w535.yaml",resolution:{width:320,height:480},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0}},m5stack_tab5:{name:"M5Stack Tab5",displayType:"color",chip:"esp32-p4",board:"esp32-p4-evboard",displayPlatform:"mipi_dsi",displayModel:"M5STACK-TAB5-V2",isPackageBased:!0,hardwarePackage:"hardware/m5stack-tab5.yaml",resolution:{width:1280,height:720},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"st7123"}},geekmagic_mini_esp8266:{name:"GeekMagic Mini (ESP8266)",displayType:"color",chip:"esp8266",board:"esp01_1m",displayPlatform:"mipi_spi",displayModel:"ST7789V",isPackageBased:!0,hardwarePackage:"hardware/geekmagic-mini-esp8266.yaml",resolution:{width:240,height:240},features:{psram:!1,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!1,inverted_colors:!1}},m5stack_coreink:{name:"M5Stack M5Core Ink (200x200)",displayType:"binary",displayModel:"1.54inv2",displayPlatform:"waveshare_epaper",resolution:{width:200,height:200},shape:"rect",features:{psram:!1,buzzer:!0,buttons:!0,lcd:!1,epaper:!0,inverted_colors:!0},chip:"esp32",board:"m5stack-coreink",pins:{display:{cs:"GPIO9",dc:"GPIO15",reset:"GPIO0",busy:null},i2c:{sda:"GPIO21",scl:"GPIO22"},spi:{clk:"GPIO18",mosi:"GPIO23"},batteryEnable:{number:"GPIO12",ignore_strapping_warning:!0},batteryAdc:"GPIO35",buzzer:"GPIO2",buttons:{left:{number:"GPIO39",mode:"INPUT"},right:{number:"GPIO37",mode:"INPUT"},refresh:{number:"GPIO38",mode:"INPUT"}}},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15}},i2c_config:{scan:!0}},m5stack_paper:{name:"M5Paper (540x960)",displayType:"grayscale",displayModel:"M5Paper",displayPlatform:"it8951e",resolution:{width:960,height:540},shape:"rect",chip:"esp32",board:"m5stack-paper",features:{psram:!0,buzzer:!1,buttons:!0,lcd:!1,epaper:!0,touch:!0,inverted_colors:!0,sht3xd:!0},pins:{display:{cs:"GPIO15",dc:null,reset:"GPIO23",busy:"GPIO27"},i2c:{sda:"GPIO21",scl:"GPIO22"},spi:{clk:"GPIO14",mosi:"GPIO12",miso:"GPIO13"},batteryEnable:null,batteryAdc:"GPIO35",buzzer:null,buttons:{left:{number:"GPIO39",mode:"INPUT"},right:{number:"GPIO37",mode:"INPUT"},refresh:{number:"GPIO38",mode:"INPUT"}}},m5paper:{battery_power_pin:"GPIO5",main_power_pin:"GPIO2"},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15}},rotation_offset:180,touch:{platform:"gt911",i2c_id:"bus_a",address:93,interrupt_pin:"GPIO36",update_interval:"never",transform:{mirror_x:!1,mirror_y:!1,swap_xy:!0},calibration:{x_min:0,x_max:960,y_min:0,y_max:540}},external_components:["  - source: github://Passific/m5paper_esphome"]},lilygo_t5_47:{id:"lilygo_t5_47",name:'Lilygo T5 4.7" E-Paper',isUntestedProfile:!0,displayType:"binary",chip:"esp32",board:"esp-wrover-kit",displayPlatform:"t547",resolution:{width:960,height:540},shape:"rect",psram_speed:"80MHz",pins:{batteryEnable:null,batteryAdc:"GPIO36",buttons:{left:{number:"GPIO39",inverted:!0,mode:"INPUT"},right:{number:"GPIO34",inverted:!0,mode:"INPUT"},refresh:{number:"GPIO35",inverted:!0,mode:"INPUT"}}},battery:{attenuation:"12db",multiplier:2},features:{psram:!0,buzzer:!1,buttons:!0,epaper:!0,inverted_colors:!0},frameworkHint:"Arduino 3.x (required by the t547 component)",system_section_overrides:{esphome:["  platformio_options:","    lib_deps:","      - https://github.com/Xinyuan-LilyGO/LilyGo-EPD47.git"],esp32:["  framework:","    type: arduino","    version: 3.3.2","  flash_size: 16MB"]},external_components:["  - source:","      type: git","      url: https://github.com/cjb0001/esphome-components","      ref: idf5-arduino3",'    components: ["t547"]']}};function _n(t=H){return Object.entries(t).filter(([,e])=>!e.isUntestedProfile).map(([e])=>e)}function eo(t,e){return t?{...t,...e,features:{...t.features||{},...e.features||{}}}:e}function to(t,e){e.forEach(n=>{t[n.id]=eo(t[n.id],n)})}function no(t,e){Object.entries(e).forEach(([n,i])=>{t[n]=i})}let vt=_n(H);async function Te(){try{const t=await Ji();_.log(`[Devices] Loaded ${t.length} hardware profiles from backend/bundle.`),to(H,t);const e=Qi(),n=Object.keys(e);n.length>0&&(_.log(`[Devices] Restoring ${n.length} offline profiles from localStorage.`),no(H,e)),vt=_n(H),P(E.DEVICE_PROFILES_UPDATED)}catch(t){_.error("Failed to load external hardware profiles:",t)}}function _e(){return"w_"+Date.now().toString(36)+Math.random().toString(36).substring(2,7)}const ge=globalThis;typeof ge.crypto<"u"&&!ge.crypto.randomUUID?Object.defineProperty(ge.crypto,"randomUUID",{value:function(){return"10000000-1000-4000-8000-100000000000".replace(/[018]/g,e=>{const n=Number(e),i=ge.crypto?.getRandomValues(new Uint8Array(1))[0]??0;return(n^(i&15)>>n/4).toString(16)})}}):typeof ge.crypto>"u"&&(ge.crypto={randomUUID:()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,t=>{const e=Math.random()*16|0;return(t==="x"?e:e&3|8).toString(16)}),getRandomValues:t=>{for(let e=0;e<t.length;e+=1)t[e]=Math.floor(Math.random()*256);return t}});function io(t,e){let n;return function(...o){const r=()=>{clearTimeout(n),t(...o)};clearTimeout(n),n=setTimeout(r,e)}}function Be(t){if(t!==void 0)return JSON.parse(JSON.stringify(t))}const da=(t,e)=>{if(!t||!e)return;const n=e.replace(/\[(\w+)\]/g,".$1").replace(/^\./,"").split(".");let i=t;for(const o of n){if(i==null)return;i=i[o]}return i};function rt(){return{id:"page_0",name:"Overview",layout:null,widgets:[]}}function oo(t){return Array.isArray(t)&&t.length>0?t:[rt()]}function Ht(t,e){return e<=0?0:Math.max(0,Math.min(t,e-1))}function ro(t){const e=t.length;let n=0;return t.forEach(i=>{const o=i.name.match(/^Page (\d+)$/);if(o){const r=parseInt(o[1],10);r>n&&(n=r)}}),{id:`page_${Date.now()}_${e}`,name:`Page ${n+1}`,widgets:[]}}function so(t,e){const n=Be(t);n.id=`page_${Date.now()}_${e}`,n.name=`${t.name} (Copy)`;const i=new Map;return n.widgets.forEach(o=>{const r=o.id,s=_e();o.id=s,i.set(r,s)}),n.widgets.forEach(o=>{o.parentId&&i.has(o.parentId)&&(o.parentId=i.get(o.parentId)||null)}),n}function ao(t,e,n,i=null,o=null,r){if(n<0||n>=t.pages.length)return!1;const s=t.pages[n],a=new Set,l=[];let c=e;const d=t.widgetsById.get(e);if(d&&d.parentId){let h=d;for(;h.parentId;){const m=t.widgetsById.get(h.parentId);if(!m)break;h=m}c=h.id}const u=h=>{if(a.has(h))return;let m=null,f=null;for(const b of t.pages)if(m=b.widgets.find(v=>v.id===h)||null,m){f=b;break}if(!m||!f||f===s)return;a.add(h),l.push({widget:m,sourcePage:f}),f.widgets.filter(b=>b.parentId===h).forEach(b=>u(b.id))};if(u(c),l.length===0)return!1;l.forEach((h,m)=>{const{widget:f,sourcePage:y}=h,b=y.widgets.indexOf(f);if(b!==-1&&y.widgets.splice(b,1),m===0&&f.parentId&&!a.has(f.parentId)&&(f.parentId=null),m===0){let v=0,x=0;if(i!==null&&o!==null&&(v=i-f.x,x=o-f.y,f.x=i,f.y=o),v!==0||x!==0)for(let w=1;w<l.length;w++){const k=l[w].widget;k.x+=v,k.y+=x}}s.widgets.push(f)});const g=r(t.protocolHardware?.orientation);for(const h of a){const m=t.widgetsById.get(h);if(!m||m.parentId&&a.has(m.parentId))continue;const f=m.x,y=m.y;m.x=Math.max(0,Math.min(g.width-(m.width||50),m.x)),m.y=Math.max(0,Math.min(g.height-(m.height||50),m.y));const b=m.x-f,v=m.y-y;if(b!==0||v!==0)for(const x of a){const w=t.widgetsById.get(x);w&&w.parentId===m.id&&(w.x+=b,w.y+=v)}}return!0}class lo{constructor(){this.state={pages:[],currentPageIndex:0,deviceName:"Layout 1",deviceModel:"reterminal_e1001",currentLayoutId:"reterminal_e1001",manualYamlOverride:"",customHardware:{},protocolHardware:{width:400,height:300,colorMode:"bw"},widgetsById:new Map},this.reset()}reset(){this.state.pages=[rt()],this.state.currentPageIndex=0,this.state.manualYamlOverride="",this.rebuildWidgetsIndex()}get pages(){return this.state.pages}get currentPageIndex(){return this.state.currentPageIndex}get deviceName(){return this.state.deviceName}get deviceModel(){return this.state.deviceModel}get currentLayoutId(){return this.state.currentLayoutId}get manualYamlOverride(){return this.state.manualYamlOverride||""}get protocolHardware(){return this.state.protocolHardware}get customHardware(){return this.state.customHardware}getCurrentPage(){return this.state.pages.length===0&&(this.state.pages=[rt()],this.state.currentPageIndex=0),this.state.pages[this.state.currentPageIndex]||this.state.pages[0]}getWidgetById(e){return this.state.widgetsById.get(e)}rebuildWidgetsIndex(){this.state.widgetsById.clear();for(const e of this.state.pages)for(const n of e.widgets)this.state.widgetsById.set(n.id,n)}setPages(e){this.state.pages=oo(e),this.state.currentPageIndex=Ht(this.state.currentPageIndex,this.state.pages.length),this.rebuildWidgetsIndex(),P(E.STATE_CHANGED)}setCurrentPageIndex(e,n={}){e>=0&&e<this.state.pages.length&&(this.state.currentPageIndex=e,P(E.PAGE_CHANGED,{index:e,...n}))}reorderPage(e,n){if(e<0||e>=this.state.pages.length||n<0||n>=this.state.pages.length)return;const[i]=this.state.pages.splice(e,1);this.state.pages.splice(n,0,i),this.state.currentPageIndex===e?this.state.currentPageIndex=n:e<this.state.currentPageIndex&&n>=this.state.currentPageIndex?this.state.currentPageIndex--:e>this.state.currentPageIndex&&n<=this.state.currentPageIndex&&this.state.currentPageIndex++,P(E.STATE_CHANGED),P(E.PAGE_CHANGED,{index:this.state.currentPageIndex,forceFocus:!0})}addPage(e=null){const n=ro(this.state.pages),i=e!==null?e:this.state.pages.length;return this.state.pages.splice(i,0,n),e!==null&&e<=this.state.currentPageIndex?this.state.currentPageIndex++:e===null&&(this.state.currentPageIndex=this.state.pages.length-1),this.rebuildWidgetsIndex(),P(E.STATE_CHANGED),P(E.PAGE_CHANGED,{index:this.state.currentPageIndex,forceFocus:!0}),n}deletePage(e){e<0||e>=this.state.pages.length||this.state.pages.length!==1&&(this.state.pages.splice(e,1),this.state.currentPageIndex=Ht(this.state.currentPageIndex,this.state.pages.length),this.rebuildWidgetsIndex(),P(E.STATE_CHANGED),P(E.PAGE_CHANGED,{index:this.state.currentPageIndex,forceFocus:!0}))}duplicatePage(e){if(e<0||e>=this.state.pages.length)return null;const n=this.state.pages[e],i=so(n,this.state.pages.length),o=e+1;return this.state.pages.splice(o,0,i),this.state.currentPageIndex=o,this.rebuildWidgetsIndex(),P(E.STATE_CHANGED),P(E.PAGE_CHANGED,{index:this.state.currentPageIndex,forceFocus:!0}),i}renamePage(e,n){e<0||e>=this.state.pages.length||!n||n.trim()===""||(this.state.pages[e].name=n.trim(),P(E.STATE_CHANGED))}addWidget(e,n=null){const i=n!==null?n:this.state.currentPageIndex;(this.state.pages[i]||this.getCurrentPage()).widgets.push(e),this.state.widgetsById.set(e.id,e),P(E.STATE_CHANGED)}updateWidget(e,n){const i=this.getWidgetById(e);i&&(Object.assign(i,n),P(E.STATE_CHANGED))}deleteWidgets(e){const n=this.getCurrentPage();let i=!1;for(const o of e){const r=n.widgets.findIndex(s=>s.id===o);r!==-1&&(n.widgets.splice(r,1),this.state.widgetsById.delete(o),i=!0)}i&&P(E.STATE_CHANGED)}moveWidgetToPage(e,n,i=null,o=null){const r=a=>this.getCanvasDimensions(a);return ao(this.state,e,n,i,o,r)?(this.rebuildWidgetsIndex(),P(E.STATE_CHANGED),!0):!1}reorderWidget(e,n,i){const o=this.state.pages[e];if(!o)return;const r=o.widgets;if(n<0||n>=r.length||i<0||i>=r.length)return;const[s]=r.splice(n,1);r.splice(i,0,s),P(E.STATE_CHANGED)}clearCurrentPage(e=!1){const n=this.getCurrentPage();if(!n)return{deleted:0,preserved:0};const i=[],o=[];return n.widgets.forEach(r=>{e&&r.locked?o.push(r):i.push(r)}),n.widgets=o,i.forEach(r=>this.state.widgetsById.delete(r.id)),i.length>0&&P(E.STATE_CHANGED),{deleted:i.length,preserved:o.length}}setDeviceSettings(e,n){e&&(this.state.deviceName=e),n&&(this.state.deviceModel=n),P(E.SETTINGS_CHANGED)}setManualYamlOverride(e,n={}){const i=typeof e=="string"?e:"";return this.state.manualYamlOverride===i?!1:(this.state.manualYamlOverride=i,n.emitStateChange!==!1&&P(E.STATE_CHANGED),!0)}clearManualYamlOverride(e={}){return this.setManualYamlOverride("",e)}getCanvasDimensions(e=nt.LANDSCAPE){const n=this.state.deviceModel||"reterminal_e1001",i=H,o=i&&i[n]?i[n]:null;let r=rn,s=sn;if(o)o.resolution&&(r=o.resolution.width,s=o.resolution.height);else if(n==="custom"&&this.state.customHardware){const a=this.state.customHardware;a.resWidth&&a.resHeight&&(r=a.resWidth,s=a.resHeight)}return e===nt.PORTRAIT?{width:Math.min(r,s),height:Math.max(r,s)}:{width:Math.max(r,s),height:Math.min(r,s)}}getPagesPayload(){return{name:this.state.deviceName,pages:this.state.pages,deviceName:this.state.deviceName,deviceModel:this.state.deviceModel,currentLayoutId:this.state.currentLayoutId,manualYamlOverride:this.state.manualYamlOverride||"",manual_yaml_override:this.state.manualYamlOverride||"",customHardware:this.state.customHardware}}getCanvasShape(){const n=H[this.state.deviceModel];return n&&n.shape?n.shape:this.state.customHardware&&this.state.customHardware.shape?this.state.customHardware.shape:"rect"}}class co{state;historyStack;historyIndex;constructor(){this.state={selectedWidgetIds:[],clipboardWidgets:[],zoomLevel:1,panX:0,panY:0},this.historyStack=[],this.historyIndex=-1}get selectedWidgetIds(){return this.state.selectedWidgetIds}get clipboardWidgets(){return this.state.clipboardWidgets}get zoomLevel(){return this.state.zoomLevel}setZoomLevel(e){this.state.zoomLevel=Math.max(.05,Math.min(5,e)),P(E.ZOOM_CHANGED,{zoomLevel:this.state.zoomLevel})}setSelectedWidgetIds(e){this.state.selectedWidgetIds=e||[],P(E.SELECTION_CHANGED,{widgetIds:this.state.selectedWidgetIds})}selectWidget(e,n=!1){if(n){const i=e?this.state.selectedWidgetIds.indexOf(e):-1;i===-1?e&&this.state.selectedWidgetIds.push(e):this.state.selectedWidgetIds.splice(i,1)}else this.state.selectedWidgetIds=e?[e]:[];P(E.SELECTION_CHANGED,{widgetIds:this.state.selectedWidgetIds})}copyWidgets(e){this.state.clipboardWidgets=e.map(n=>Be(n)),_.log("[EditorStore] Widgets copied to clipboard:",this.state.clipboardWidgets.length)}recordHistory(e){const n=Be(e);if(this.historyIndex>=0){const i=this.historyStack[this.historyIndex];if(JSON.stringify(i)===JSON.stringify(n))return}this.historyIndex<this.historyStack.length-1&&(this.historyStack=this.historyStack.slice(0,this.historyIndex+1)),this.historyStack.push(n),this.historyIndex++,this.historyStack.length>nn&&(this.historyStack.shift(),this.historyIndex--),P(E.HISTORY_CHANGED,{canUndo:this.canUndo(),canRedo:this.canRedo()})}replaceHistory(e){this.historyStack=[Be(e)],this.historyIndex=0,P(E.HISTORY_CHANGED,{canUndo:this.canUndo(),canRedo:this.canRedo()})}undo(){return this.canUndo()?(this.historyIndex--,this.historyStack[this.historyIndex]):null}redo(){return this.canRedo()?(this.historyIndex++,this.historyStack[this.historyIndex]):null}canUndo(){return this.historyIndex>0}canRedo(){return this.historyIndex<this.historyStack.length-1}}class po{constructor(){this.state={...tn}}get snapEnabled(){return this.state.snapEnabled}get showGrid(){return this.state.showGrid}get showDebugGrid(){return!!this.state.showDebugGrid}get showRulers(){return!!this.state.showRulers}get autoSaveEnabled(){return this.state.autoSaveEnabled!==!1}get gridOpacity(){return this.state.gridOpacity}get editor_light_mode(){return this.state.editor_light_mode}update(e){this.state={...this.state,...e},P(E.SETTINGS_CHANGED,this.state),_.log("[PreferencesStore] Settings updated")}setSnapEnabled(e){this.state.snapEnabled=e,P(E.SETTINGS_CHANGED,{snapEnabled:e})}setShowGrid(e){this.state.showGrid=e,P(E.SETTINGS_CHANGED,{showGrid:e})}setShowDebugGrid(e){this.state.showDebugGrid=e,P(E.SETTINGS_CHANGED,{showDebugGrid:e})}setShowRulers(e){this.state.showRulers=e,P(E.SETTINGS_CHANGED,{showRulers:e})}setAutoSaveEnabled(e){this.state.autoSaveEnabled=e,P(E.SETTINGS_CHANGED,{autoSaveEnabled:e})}}function Gt(){try{return globalThis.localStorage??null}catch{return null}}class uo{constructor(){this.keys={ai_api_key_gemini:"",ai_api_key_openai:"",ai_api_key_openrouter:""},this.loadFromLocalStorage()}get(e){return this.keys[e]||""}set(e,n){if(e in this.keys){const i=this.keys;i[e]=n,this.saveToLocalStorage()}}saveToLocalStorage(){try{const e=Gt();if(!e)return;const n={};Object.keys(this.keys).forEach(i=>{i.startsWith("ai_api_key_")&&(n[i]=this.keys[i])}),e.setItem("esphome-designer-ai-keys",JSON.stringify(n))}catch(e){_.warn("[SecretsStore] Failed to save AI keys to localStorage:",e)}}loadFromLocalStorage(){try{const e=Gt();if(!e)return;const n=e.getItem("esphome-designer-ai-keys");if(n){const i=JSON.parse(n);i&&typeof i=="object"&&(this.keys={...this.keys,...i},_.log("[SecretsStore] AI keys loaded from local storage"))}}catch(e){_.warn("[SecretsStore] Failed to load AI keys from localStorage:",e)}}}class ho{constructor(e){this.app=e}selectWidget(e,n=!1){if(!e){this.app.editor.selectWidget(null,n);return}const i=this.app.getWidgetById(e);if(i)if(i.type==="group"){const a=(this.app.getCurrentPage().widgets||[]).filter(c=>c.parentId===e).map(c=>c.id),l=[e,...a];if(n)if(l.some(d=>this.app.editor.selectedWidgetIds.includes(d))){const d=new Set(l),u=this.app.editor.selectedWidgetIds.filter(g=>!d.has(g));this.app.editor.setSelectedWidgetIds(u)}else this.app.editor.setSelectedWidgetIds([...new Set([...this.app.editor.selectedWidgetIds,...l])]);else this.app.editor.setSelectedWidgetIds(l)}else this.app.editor.selectWidget(e,n)}selectWidgets(e){this.app.editor.setSelectedWidgetIds(e)}selectAllWidgets(){const e=this.app.getCurrentPage();if(!e||!e.widgets)return;const i=e.widgets.map(o=>o.id);this.selectWidgets(i)}deselectAll(){this.app.editor.setSelectedWidgetIds([])}toggleSelection(e){this.selectWidget(e,!0)}isWidgetSelected(e){return this.app.editor.selectedWidgetIds.includes(e)}groupSelection(){const e=this.app.editor.selectedWidgetIds,n=this.app.getSelectedWidgets(),i=n.some(d=>d.type==="group"||d.parentId);if(e.length<2||i)return;let o=1/0,r=1/0,s=-1/0,a=-1/0;n.forEach(d=>{o=Math.min(o,d.x),r=Math.min(r,d.y),s=Math.max(s,d.x+(d.width||0)),a=Math.max(a,d.y+(d.height||0))});const l="group_"+_e(),c={id:l,type:"group",title:"Group",x:o,y:r,width:s-o,height:a-r,props:{},expanded:!0};this.app.project.addWidget(c),n.forEach(d=>{this.app.project.updateWidget(d.id,{parentId:l})}),this.selectWidget(l),this.app.syncWidgetOrderWithHierarchy(),this.app.recordHistory(),P(E.STATE_CHANGED)}ungroupSelection(e=null){const n=this.app;let i=[];if(e)i=Array.isArray(e)?e:[e];else{const l=n.getSelectedWidgets(),c=new Set;l.forEach(d=>{d.type==="group"?c.add(d.id):d.parentId&&c.add(d.parentId)}),i=[...c]}const o=new Set;i.forEach(l=>{const c=n.getWidgetById(l);c&&(c.type==="group"?o.add(c.id):c.parentId&&o.add(c.parentId))});const r=[...o];if(r.length===0)return;const s=[];r.forEach(l=>{const c=n.getWidgetById(l);if(!c||c.type!=="group")return;(n.getCurrentPage().widgets||[]).filter(h=>h.parentId===l).forEach(h=>{this.app.project.updateWidget(h.id,{parentId:null}),s.push(h.id)})}),this.app.project.deleteWidgets(r);const a=n.getCurrentPage();if(a&&a.widgets){const l=a.widgets;a.widgets=l.filter(c=>!r.includes(c.id))}s.length>0&&this.selectWidgets(s),n.syncWidgetOrderWithHierarchy(),n.recordHistory(),P(E.STATE_CHANGED)}alignSelectedWidgets(e){const n=this.app.getSelectedWidgets();if(n.length<2)return;let i;switch(e){case"left":i=Math.min(...n.map(o=>o.x)),n.forEach(o=>this.app.project.updateWidget(o.id,{x:i}));break;case"center":{const o=Math.min(...n.map(s=>s.x)),r=Math.max(...n.map(s=>s.x+(s.width||0)));i=o+(r-o)/2,n.forEach(s=>this.app.project.updateWidget(s.id,{x:i-(s.width||0)/2}));break}case"right":i=Math.max(...n.map(o=>o.x+(o.width||0))),n.forEach(o=>this.app.project.updateWidget(o.id,{x:i-(o.width||0)}));break;case"top":i=Math.min(...n.map(o=>o.y)),n.forEach(o=>this.app.project.updateWidget(o.id,{y:i}));break;case"middle":{const o=Math.min(...n.map(s=>s.y)),r=Math.max(...n.map(s=>s.y+(s.height||0)));i=o+(r-o)/2,n.forEach(s=>this.app.project.updateWidget(s.id,{y:i-(s.height||0)/2}));break}case"bottom":i=Math.max(...n.map(o=>o.y+(o.height||0))),n.forEach(o=>this.app.project.updateWidget(o.id,{y:i-(o.height||0)}));break}this.app.recordHistory(),P(E.STATE_CHANGED)}distributeSelectedWidgets(e){const n=this.app.getSelectedWidgets();if(!(n.length<3)){if(e==="horizontal"){const i=[...n].sort((d,u)=>d.x-u.x),o=i[0],s=i[i.length-1].x-(o.x+(o.width||0)),a=i.slice(1,-1).reduce((d,u)=>d+(u.width||0),0),l=(s-a)/(i.length-1);let c=o.x+(o.width||0)+l;for(let d=1;d<i.length-1;d++)this.app.project.updateWidget(i[d].id,{x:c}),c+=(i[d].width||0)+l}else{const i=[...n].sort((d,u)=>d.y-u.y),o=i[0],s=i[i.length-1].y-(o.y+(o.height||0)),a=i.slice(1,-1).reduce((d,u)=>d+(u.height||0),0),l=(s-a)/(i.length-1);let c=o.y+(o.height||0)+l;for(let d=1;d<i.length-1;d++)this.app.project.updateWidget(i[d].id,{y:c}),c+=(i[d].height||0)+l}this.app.recordHistory(),P(E.STATE_CHANGED)}}}class go{constructor(e){this.app=e}recordHistory(){this.app._isRestoringHistory||this.app.editor.recordHistory({pages:this.app.project.pages,deviceName:this.app.project.deviceName})}replaceHistoryBaseline(){this.app.editor.replaceHistory({pages:this.app.project.pages,deviceName:this.app.project.deviceName})}undo(){const e=this.app.editor.undo();e&&(this.app.setInternalFlag("_isRestoringHistory",!0),this.restoreSnapshot(e),setTimeout(()=>{this.app.setInternalFlag("_isRestoringHistory",!1)},0))}redo(){const e=this.app.editor.redo();e&&(this.app.setInternalFlag("_isRestoringHistory",!0),this.restoreSnapshot(e),setTimeout(()=>{this.app.setInternalFlag("_isRestoringHistory",!1)},0))}restoreSnapshot(e){this.app.project.state.pages=JSON.parse(JSON.stringify(e.pages)),this.app.project.state.deviceName=e.deviceName,this.app.project.rebuildWidgetsIndex(),P(E.STATE_CHANGED)}canUndo(){return this.app.editor.canUndo()}canRedo(){return this.app.editor.canRedo()}}let st={};try{st=Object.assign({"../../features/battery_icon/plugin.js":()=>L(()=>import("./plugin-CPcR7vDF.js"),__vite__mapDeps([0,1,2]),import.meta.url),"../../features/calendar/plugin.js":()=>L(()=>import("./plugin-CeW8jwHH.js"),__vite__mapDeps([3,1,2]),import.meta.url),"../../features/datetime/plugin.js":()=>L(()=>import("./plugin-Z34jSsax.js"),__vite__mapDeps([4,2,1]),import.meta.url),"../../features/debug_grid/plugin.js":()=>L(()=>import("./plugin-Bz96grI8.js"),[],import.meta.url),"../../features/energy_widget/plugin.js":()=>L(()=>import("./plugin-BgOFjDX_.js"),__vite__mapDeps([5,1,2]),import.meta.url),"../../features/graph/plugin.js":()=>L(()=>import("./plugin-6Gcd-kVX.js"),__vite__mapDeps([6,2,1]),import.meta.url),"../../features/icon/plugin.js":()=>L(()=>import("./plugin-BmY2LCkY.js"),__vite__mapDeps([7,8,9,1,2]),import.meta.url),"../../features/image/plugin.js":()=>L(()=>import("./plugin-D9iw6_af.js"),__vite__mapDeps([10,1,2]),import.meta.url),"../../features/line/plugin.js":()=>L(()=>import("./plugin-DPpv4k9S.js"),[],import.meta.url),"../../features/lvgl_arc/plugin.js":()=>L(()=>import("./plugin-D1imDjBd.js"),__vite__mapDeps([11,1,2]),import.meta.url),"../../features/lvgl_bar/plugin.js":()=>L(()=>import("./plugin-CN6lT8h5.js"),[],import.meta.url),"../../features/lvgl_button/plugin.js":()=>L(()=>import("./plugin-C3Mqh3qw.js"),__vite__mapDeps([12,2,1]),import.meta.url),"../../features/lvgl_buttonmatrix/plugin.js":()=>L(()=>import("./plugin-BYUEJW46.js"),[],import.meta.url),"../../features/lvgl_chart/plugin.js":()=>L(()=>import("./plugin-uULqxqmr.js"),[],import.meta.url),"../../features/lvgl_checkbox/plugin.js":()=>L(()=>import("./plugin-Dfv7sJ9a.js"),__vite__mapDeps([13,2,1]),import.meta.url),"../../features/lvgl_dropdown/plugin.js":()=>L(()=>import("./plugin-DKvu6nsr.js"),[],import.meta.url),"../../features/lvgl_img/plugin.js":()=>L(()=>import("./plugin-CJupQF3Y.js"),[],import.meta.url),"../../features/lvgl_keyboard/plugin.js":()=>L(()=>import("./plugin-5CX7J5Ir.js"),[],import.meta.url),"../../features/lvgl_label/plugin.js":()=>L(()=>import("./plugin-BEKGuk-X.js"),__vite__mapDeps([14,1,2]),import.meta.url),"../../features/lvgl_led/plugin.js":()=>L(()=>import("./plugin-CvW9GRcJ.js"),[],import.meta.url),"../../features/lvgl_line/plugin.js":()=>L(()=>import("./plugin-DavNvZJ0.js"),[],import.meta.url),"../../features/lvgl_meter/plugin.js":()=>L(()=>import("./plugin-03wdAHv5.js"),[],import.meta.url),"../../features/lvgl_obj/plugin.js":()=>L(()=>import("./plugin-Cvfrg4uG.js"),[],import.meta.url),"../../features/lvgl_qrcode/plugin.js":()=>L(()=>import("./plugin-BZNoAt0h.js"),[],import.meta.url),"../../features/lvgl_roller/plugin.js":()=>L(()=>import("./plugin-H8_Cedxq.js"),[],import.meta.url),"../../features/lvgl_slider/plugin.js":()=>L(()=>import("./plugin-DA01fNui.js"),[],import.meta.url),"../../features/lvgl_spinbox/plugin.js":()=>L(()=>import("./plugin-CCSLU7VJ.js"),[],import.meta.url),"../../features/lvgl_spinner/plugin.js":()=>L(()=>import("./plugin-yr1brk0v.js"),[],import.meta.url),"../../features/lvgl_switch/plugin.js":()=>L(()=>import("./plugin-FrfJeL0b.js"),__vite__mapDeps([15,2,1]),import.meta.url),"../../features/lvgl_tabview/plugin.js":()=>L(()=>import("./plugin-Z-WZZzFC.js"),[],import.meta.url),"../../features/lvgl_textarea/plugin.js":()=>L(()=>import("./plugin-Dft6HFQs.js"),[],import.meta.url),"../../features/lvgl_tileview/plugin.js":()=>L(()=>import("./plugin-CIe8d1NL.js"),[],import.meta.url),"../../features/moon_phase/plugin.js":()=>L(()=>import("./plugin-B79LnPQM.js"),__vite__mapDeps([16,2,1]),import.meta.url),"../../features/odp_arc/plugin.js":()=>L(()=>import("./plugin-fLOMRvii.js"),[],import.meta.url),"../../features/odp_ellipse/plugin.js":()=>L(()=>import("./plugin-FRwyy2yN.js"),[],import.meta.url),"../../features/odp_icon_sequence/plugin.js":()=>L(()=>import("./plugin-CciJdC0y.js"),[],import.meta.url),"../../features/odp_multiline/plugin.js":()=>L(()=>import("./plugin-C4VhGPFM.js"),[],import.meta.url),"../../features/odp_plot/plugin.js":()=>L(()=>import("./plugin-B97TN5cD.js"),[],import.meta.url),"../../features/odp_polygon/plugin.js":()=>L(()=>import("./plugin-C_hkq-qm.js"),[],import.meta.url),"../../features/odp_rectangle_pattern/plugin.js":()=>L(()=>import("./plugin-BMFaRNdP.js"),[],import.meta.url),"../../features/ondevice_humidity/plugin.js":()=>L(()=>import("./plugin-Dl41MHLG.js"),__vite__mapDeps([17,1,2]),import.meta.url),"../../features/ondevice_temperature/plugin.js":()=>L(()=>import("./plugin-Nkudmld7.js"),__vite__mapDeps([18,1,2]),import.meta.url),"../../features/online_image/plugin.js":()=>L(()=>import("./plugin-CN5hJcPi.js"),__vite__mapDeps([19,1,2]),import.meta.url),"../../features/progress_bar/plugin.js":()=>L(()=>import("./plugin-Cfqp4H93.js"),__vite__mapDeps([20,21,1,2]),import.meta.url),"../../features/qr_code/plugin.js":()=>L(()=>import("./plugin-Ben8J_wa.js"),__vite__mapDeps([22,1,2]),import.meta.url),"../../features/quote_rss/plugin.js":()=>L(()=>import("./plugin-7Ac3QoAr.js"),__vite__mapDeps([23,1,2]),import.meta.url),"../../features/rounded_rect/plugin.js":()=>L(()=>import("./plugin-Qs4iVGg-.js"),__vite__mapDeps([24,25,1,2]),import.meta.url),"../../features/sensor_text/plugin.js":()=>L(()=>import("./plugin-BSzHne7y.js"),__vite__mapDeps([26,9,21,2,1]),import.meta.url),"../../features/shape_circle/plugin.js":()=>L(()=>import("./plugin-CJ9nbTHc.js"),__vite__mapDeps([27,25,1,2]),import.meta.url),"../../features/shape_rect/plugin.js":()=>L(()=>import("./plugin-4N9f5ieb.js"),__vite__mapDeps([28,25,1,2]),import.meta.url),"../../features/sun_times/plugin.js":()=>L(()=>import("./plugin-jd6Tjimq.js"),__vite__mapDeps([29,2,1]),import.meta.url),"../../features/template_nav_bar/plugin.js":()=>L(()=>import("./plugin-DnpMTeW7.js"),__vite__mapDeps([30,2,1]),import.meta.url),"../../features/template_sensor_bar/plugin.js":()=>L(()=>import("./plugin-CvPdXSA-.js"),__vite__mapDeps([31,1,2]),import.meta.url),"../../features/text/plugin.js":()=>L(()=>import("./plugin-z4CIjjsH.js"),__vite__mapDeps([32,9,2,1]),import.meta.url),"../../features/touch_area/plugin.js":()=>L(()=>import("./plugin-CWDUhTLI.js"),__vite__mapDeps([33,2,1,8]),import.meta.url),"../../features/weather_forecast/plugin.js":()=>L(()=>import("./plugin-CnOYPMlf.js"),__vite__mapDeps([34,35,1,2]),import.meta.url),"../../features/weather_icon/plugin.js":()=>L(()=>import("./plugin-DLwngaPb.js"),__vite__mapDeps([36,2,1,35]),import.meta.url),"../../features/wifi_signal/plugin.js":()=>L(()=>import("./plugin-Dyc9tJh2.js"),__vite__mapDeps([37,1,2]),import.meta.url)})}catch{}class mo{constructor(){this.plugins=new Map,this.loading=new Map,this.aliases={label:"text",rectangle:"shape_rect",rrect:"rounded_rect",circle:"shape_circle",nav_next_page:"touch_area",nav_previous_page:"touch_area",nav_reload_page:"touch_area",puppet:"online_image",multiline:"odp_multiline",rectangle_pattern:"odp_rectangle_pattern",polygon:"odp_polygon",ellipse:"odp_ellipse",icon_sequence:"odp_icon_sequence",weather_forcast:"weather_forecast",odp_debug_grid:"debug_grid",lv_chart:"lvgl_chart"}}register(e){if(!e?.id){_.warn("[Registry] Invalid plugin registration attempt:",e);return}const n=e.id,i=this.plugins.get(n);this.plugins.set(n,{...i||{},...e}),_.log(`[Registry] Registered: ${n}`)}get(e){const n=this.aliases[e]||e;return this.plugins.get(n)}getAll(){return Array.from(this.plugins.values())}async load(e){const n=this.aliases[e]||e;if(n==="group")return null;const i=this.plugins.get(n);if(i)return i;const o=this.loading.get(n);if(o)return o;const r=(async()=>{try{const s=`../../features/${n}/plugin.js`,a=st[s]?await st[s]():await import(s);let l;return a.default?l=a.default:l={id:n,...a},this.register(l),this.plugins.get(n)??null}catch(s){return _.error(`[Registry] Failed to load plugin "${n}" from ESM:`,s),null}finally{this.loading.delete(n)}})();return this.loading.set(n,r),r}runHook(e,n){this.getAll().forEach(i=>{const o=e==="onCollectRequirements"?i.collectRequirements:i[e];typeof o=="function"&&o.call(i,n)})}onExportGlobals(e){this.runHook("onExportGlobals",e)}onExportEsphome(e){this.runHook("onExportEsphome",e)}onExportNumericSensors(e){this.runHook("onExportNumericSensors",e)}onExportTextSensors(e){this.runHook("onExportTextSensors",e)}onExportBinarySensors(e){this.runHook("onExportBinarySensors",e)}onExportHelpers(e){this.runHook("onExportHelpers",e)}onExportComponents(e){this.runHook("onExportComponents",e)}onCollectRequirements(e){this.runHook("onCollectRequirements",e)}}const q=new mo;_.log("[Registry] Modular system ready.");class fo{constructor(e){this.app=e}normalizeWidgetIds(e){return e?Array.isArray(e)?e:[...e]:[]}setCustomHardware(e){this.app.project.state.customHardware=e,P(E.STATE_CHANGED),P(E.PAGE_CHANGED,{index:this.app.currentPageIndex,forceFocus:!0})}addWidget(e,n=null){this.checkRenderingModeForWidget(e),this.app.project.addWidget(e,n),this.app.recordHistory(),this.app.selectWidget(e.id),P(E.STATE_CHANGED)}updateWidget(e,n){const i=this.app,o=i.getWidgetById(e),r=this.sanitizeParentUpdate(o,n);if(this.app.project.updateWidget(e,r),o&&o.type==="group"){const s=["locked","hidden"],a={},l=r||{};if(s.forEach(c=>{l[c]!==void 0&&(a[c]=l[c])}),Object.keys(a).length>0){const c=i.pages[i.currentPageIndex];c&&c.widgets&&c.widgets.filter(u=>u.parentId===e).forEach(u=>this.updateWidget(u.id,a))}}r.parentId!==void 0&&this.syncWidgetOrderWithHierarchy(),P(E.STATE_CHANGED)}sanitizeParentUpdate(e,n){if(!n||n.parentId===void 0||!e)return n;let i=n.parentId||null;if(e.type==="group"||i===e.id)i=null;else if(i){const o=this.app.getWidgetById(i);(!o||o.type!=="group")&&(i=null)}return i===n.parentId?n:{...n,parentId:i}}updateWidgets(e,n){e.forEach(i=>this.app.project.updateWidget(i,n)),P(E.STATE_CHANGED)}updateWidgetsProps(e,n){const i=[],o=n.radius??n.border_radius??n.corner_radius;e.forEach(r=>{const s=this.app.getWidgetById(r);if(s){const a={...s.props||{},...n};if(this.app.project.updateWidget(r,{props:a}),o!==void 0&&s.parentId){const l=this.app.getWidgetById(s.parentId);if(l&&l.type==="group"&&l.title&&l.title.endsWith("Group")){const d=(this.app.getCurrentPage()?.widgets.filter(u=>u.parentId===l.id)||[]).find(u=>u.id!==s.id&&u.props?.name&&u.props.name.endsWith("Shadow"));d&&i.push({id:d.id,props:{...d.props||{},radius:o}})}}}}),i.forEach(r=>{this.app.project.updateWidget(r.id,{props:r.props})}),P(E.STATE_CHANGED)}deleteWidget(e){const n=e?[e]:this.normalizeWidgetIds(this.app.editor.selectedWidgetIds),i=[...n];n.forEach(o=>{const r=this.app.getWidgetById(o);r&&r.type==="group"&&this.app.pages[this.app.currentPageIndex].widgets.filter(a=>a.parentId===o).forEach(a=>i.push(a.id))}),this.app.project.deleteWidgets([...new Set(i)]),this.app.editor.setSelectedWidgetIds([]),this.app.recordHistory(),P(E.STATE_CHANGED)}moveWidgetToPage(e,n,i=null,o=null){const r=this.app.getWidgetById(e);if(!r)return!1;const s=this.app.getCurrentPage(),a=this.app.pages[n];if(!s||!a)return!1;const l=[r];if(r.type==="group"){const g=s.widgets.filter(h=>h.parentId===e);l.push(...g)}const c=i!==null?i-r.x:0,d=o!==null?o-r.y:0,u=new Set(l.map(g=>g.id));return s.widgets=s.widgets.filter(g=>!u.has(g.id)),l.forEach(g=>{const h=JSON.parse(JSON.stringify(g));g.id===e?(i!==null&&(h.x=i),o!==null&&(h.y=o)):(h.x+=c,h.y+=d),a.widgets.push(h)}),this.app.project.rebuildWidgetsIndex(),this.app.recordHistory(),P(E.STATE_CHANGED),!0}copyWidget(e){const i=(e?[e]:this.normalizeWidgetIds(this.app.editor.selectedWidgetIds)).map(o=>this.app.getWidgetById(o)).filter(o=>!!o);i.length>0&&this.app.editor.copyWidgets(i)}pasteWidget(){const e=this.app.editor,n=e.clipboardWidgets;if(!n||n.length===0)return;const i=n.map(o=>{const r=JSON.parse(JSON.stringify(o));return r.id=_e(),r.x+=10,r.y+=10,r});i.forEach(o=>{this.checkRenderingModeForWidget(o),this.app.project.addWidget(o)}),e.setSelectedWidgetIds(i.map(o=>o.id)),this.app.recordHistory(),P(E.STATE_CHANGED)}createDropShadow(e){const n=Array.isArray(e)?e:[e];if(n.length===0)return;const i=this.app.project.getCurrentPage();if(!i||!i.widgets)return;const o=i?i.dark_mode:void 0;let r=!1;o==="dark"?r=!0:o==="light"?r=!1:r=!!this.app.settings.dark_mode;const s=u=>{if(typeof u!="string")return!1;const g=u.trim().toLowerCase();return g===""||g==="transparent"||g==="transp"},a=(...u)=>u.find(g=>typeof g=="string"&&!s(g)),l=r?"white":"black",c="white",d=[];n.forEach(u=>{const g=this.app.getWidgetById(u);if(!g)return;const h=parseInt(g.props?.border_radius||g.props?.radius||g.props?.corner_radius||0,10);let m="shape_rect";g.type==="shape_circle"||g.type==="circle"?m="shape_circle":h>0&&(m="rounded_rect");const f={id:_e(),type:m,x:(g.x||0)+5,y:(g.y||0)+5,width:g.width,height:g.height,props:{name:(g.props?.name||g.type)+" Shadow",bg_color:l,border_color:l}};m==="rounded_rect"&&(f.props.radius=h),this.app.project.addWidget(f),g.props||(g.props={});const y=["shape_rect","rounded_rect","shape_circle","rectangle","rrect","circle"].includes(g.type),x=(y&&(a(g.props.bg_color,g.props.color)||g.props.fill)?a(g.props.bg_color,g.props.color):null)??a(g.props.bg_color,g.props.background_color)??c;y?(g.props.bg_color=x,delete g.props.background_color,delete g.props.fill):(g.props.fill=!0,(g.props.bg_color!==void 0||g.props.background_color===void 0)&&(g.props.bg_color=x),g.props.background_color!==void 0&&(g.props.background_color=x)),this.app.project.updateWidget(u,{props:{...g.props}});const w=i.widgets.findIndex(D=>D.id===u),k=i.widgets.findIndex(D=>D.id===f.id);w!==-1&&k!==-1&&this.app.project.reorderWidget(this.app.project.currentPageIndex,k,w);const C="group_"+_e(),S=Math.min(g.x,f.x),I=Math.min(g.y,f.y),T=Math.max(g.x+g.width,f.x+f.width),O=Math.max(g.y+g.height,f.y+f.height),M={id:C,type:"group",title:g.props?.name?`${g.props.name} Group`:"Shadow Group",x:S,y:I,width:T-S,height:O-I,props:{},expanded:!0};this.app.project.addWidget(M),this.app.project.updateWidget(f.id,{parentId:C}),this.app.project.updateWidget(g.id,{parentId:C}),d.push(C)}),d.length>0&&this.app.selectWidgets(d),this.syncWidgetOrderWithHierarchy(),this.app.recordHistory(),P(E.STATE_CHANGED)}syncWidgetOrderWithHierarchy(){const e=this.app.getCurrentPage();if(!e||!e.widgets)return;const n=[...e.widgets],i=n.filter(a=>a.type==="group"||!a.parentId),o=new Map;n.forEach(a=>{if(a.parentId&&a.type!=="group"){o.has(a.parentId)||o.set(a.parentId,[]);const l=o.get(a.parentId);l&&l.push(a)}});const r=[],s=a=>{r.push(a);const l=o.get(a.id);l&&(l.sort((c,d)=>n.indexOf(c)-n.indexOf(d)),l.forEach(s))};i.forEach(s),e.widgets=r,this.app.project.rebuildWidgetsIndex()}syncWidgetVisibilityWithMode(){const e=this.app.preferences.state.renderingMode||"direct";_.log(`[AppState] Syncing widget visibility for mode: ${e}`);let n=0;this.app.project.pages.forEach(i=>{i.widgets.forEach(o=>{const r=this.isWidgetCompatibleWithMode(o,e);!r&&!o.hidden?(o.hidden=!0,n++):r&&o.hidden&&(o.hidden=!1,n++)})}),n>0&&(_.log(`[AppState] Updated ${n} widgets due to mode switch.`),this.app.project.rebuildWidgetsIndex(),P(E.STATE_CHANGED))}isWidgetCompatibleWithMode(e,n){const i=q.get(e.type);if(!i)return!0;if(n==="oepl")return!!i.exportOEPL;if(n==="opendisplay")return!!i.exportOpenDisplay;if(n==="lvgl"){const o=e.type&&e.type.startsWith("lvgl_"),r=typeof i.exportLVGL=="function";return o||r}if(n==="direct"||n==="c"){const o=e.type&&(e.type.startsWith("lvgl_")||e.type.startsWith("oepl_"));return!!i.export&&!o}return!0}checkRenderingModeForWidget(e){if(!e||!e.type)return;const n=this.app.preferences.state.renderingMode||"direct",i=e.type.startsWith("lvgl_"),o=e.type.startsWith("oepl_"),r=e.type.startsWith("odp_")||e.type.startsWith("opendisplay_");i&&n==="direct"?(this.app.updateSettings({renderingMode:"lvgl"}),_.log(`[AppState] Auto-switched to LVGL rendering mode because an LVGL widget (${e.type}) was added.`),A("Auto-switched to LVGL rendering mode","info")):o&&n!=="oepl"?(this.app.updateSettings({renderingMode:"oepl"}),_.log(`[AppState] Auto-switched to OEPL rendering mode because an OEPL widget (${e.type}) was added.`),A("Auto-switched to OEPL mode","info")):r&&n!=="opendisplay"&&(this.app.updateSettings({renderingMode:"opendisplay"}),_.log(`[AppState] Auto-switched to OpenDisplay (ODP) mode because an ODP widget (${e.type}) was added.`),A("Auto-switched to ODP mode","info"))}}class yo{constructor(e){this.app=e}reorderWidget(e,n,i){this.app.project.reorderWidget(e,n,i),this.app.widgetManager.syncWidgetOrderWithHierarchy(),this.app.recordHistory(),P(E.STATE_CHANGED)}setCurrentPageIndex(e,n={}){this.app.project.setCurrentPageIndex(e,n),this.app.editor.setSelectedWidgetIds([]),P(E.STATE_CHANGED)}reorderPage(e,n){this.app.project.reorderPage(e,n),this.app.recordHistory()}addPage(e=null){const n=this.app.project.addPage(e);return this.app.recordHistory(),n}deletePage(e){this.app.project.deletePage(e),this.app.recordHistory()}duplicatePage(e){const n=this.app.project.duplicatePage(e);return this.app.recordHistory(),n}renamePage(e,n){this.app.project.renamePage(e,n),this.app.recordHistory()}clearCurrentPage(e=!1){const n=this.app.project.clearCurrentPage(e);return n.deleted>0&&(this.app.editor.setSelectedWidgetIds([]),this.app.recordHistory(),P(E.STATE_CHANGED)),n}}class vo{project;editor;preferences;secrets;selectionManager;historyManager;widgetManager;pageManager;_isRestoringHistory;isUndoRedoInProgress;entityStates;$raw;constructor(){this.project=new lo,this.editor=new co,this.preferences=new po,this.secrets=new uo,this.selectionManager=new ho(this),this.historyManager=new go(this),this.widgetManager=new fo(this),this.pageManager=new yo(this),this._isRestoringHistory=!1,this.isUndoRedoInProgress=!1,this.entityStates={},this.recordHistory(),W(E.SETTINGS_CHANGED,e=>{e&&e.renderingMode!==void 0&&this.syncWidgetVisibilityWithMode()})}reset(){this.project.reset(),this.editor.state.selectedWidgetIds=[],this.recordHistory()}get pages(){return this.project.pages}get state(){return this.project.state}get currentPageIndex(){return this.project.currentPageIndex}get selectedWidgetId(){return this.editor.selectedWidgetIds[0]||null}get selectedWidgetIds(){return this.editor.selectedWidgetIds}get settings(){return{...this.preferences.state,device_name:this.project.deviceName,deviceName:this.project.deviceName,device_model:this.project.deviceModel,deviceModel:this.project.deviceModel,customHardware:this.project.customHardware,custom_hardware:this.project.customHardware,protocolHardware:this.project.protocolHardware,protocol_hardware:this.project.protocolHardware,...this.secrets.keys}}get deviceName(){return this.project.deviceName}get deviceModel(){return this.project.deviceModel}get currentLayoutId(){return this.project.currentLayoutId}get manualYamlOverride(){return this.project.manualYamlOverride}get snapEnabled(){return this.preferences.snapEnabled}get showGrid(){return this.preferences.showGrid}get showDebugGrid(){return this.preferences.showDebugGrid}get showRulers(){return this.preferences.showRulers}get zoomLevel(){return this.editor.zoomLevel}getCurrentPage(){return this.project.getCurrentPage()}getWidgetById(e){return this.project.getWidgetById(e)}getSelectedWidget(){return this.project.getWidgetById(this.editor.selectedWidgetIds[0])}getSelectedWidgets(){return this.editor.selectedWidgetIds.map(e=>this.getWidgetById(e)).filter(e=>!!e)}getSelectedProfile(){const e=H;return this.project.deviceModel&&e[this.project.deviceModel]||null}getCanvasDimensions(){const e=this.preferences.state.renderingMode||"direct";if(e==="oepl"||e==="opendisplay"){const n=this.project.protocolHardware;return this.preferences.state.orientation==="portrait"?{width:Math.min(n.width,n.height),height:Math.max(n.width,n.height)}:{width:Math.max(n.width,n.height),height:Math.min(n.width,n.height)}}return this.project.getCanvasDimensions(this.preferences.state.orientation||"landscape")}getCanvasShape(){return this.project.getCanvasShape()}getPagesPayload(){const e={...this.project.getPagesPayload(),currentPageIndex:this.currentPageIndex,...this.settings};return e.deviceModel=this.project.deviceModel||void 0,e.customHardware=this.project.customHardware,e.protocolHardware=this.project.protocolHardware,e.device_model=this.project.deviceModel||void 0,e.custom_hardware=this.project.customHardware,e.protocol_hardware=this.project.protocolHardware,e}getSettings(){return this.settings}getManualYamlOverride(){return this.project.manualYamlOverride}setSettings(e){this.updateSettings(e)}updateProtocolHardware(e){Object.assign(this.project.state.protocolHardware,e),P(E.SETTINGS_CHANGED),P(E.PAGE_CHANGED,{index:this.currentPageIndex,forceFocus:!0})}saveToLocalStorage(){if(!N()){const e=this.getPagesPayload();localStorage.setItem("esphome-designer-layout",JSON.stringify(e))}}loadFromLocalStorage(){try{const e=localStorage.getItem("esphome-designer-layout");return e?JSON.parse(e):null}catch(e){return _.error("[loadFromLocalStorage] Parse error:",e),null}}setPages(e){this.project.setPages(e),P(E.STATE_CHANGED)}reorderWidget(e,n,i){this.pageManager.reorderWidget(e,n,i)}setCurrentPageIndex(e,n={}){this.pageManager.setCurrentPageIndex(e,n)}reorderPage(e,n){this.pageManager.reorderPage(e,n)}addPage(e=null){return this.pageManager.addPage(e)}deletePage(e){this.pageManager.deletePage(e)}duplicatePage(e){return this.pageManager.duplicatePage(e)}renamePage(e,n){this.pageManager.renamePage(e,n)}selectWidget(e,n=!1){this.selectionManager.selectWidget(e,n)}selectWidgets(e){this.selectionManager.selectWidgets(e)}selectAllWidgets(){this.selectionManager.selectAllWidgets()}deselectAll(){this.selectionManager.deselectAll()}toggleSelection(e){this.selectionManager.toggleSelection(e)}isWidgetSelected(e){return this.selectionManager.isWidgetSelected(e)}groupSelection(){this.selectionManager.groupSelection()}ungroupSelection(e=null){this.selectionManager.ungroupSelection(e)}alignSelectedWidgets(e){this.selectionManager.alignSelectedWidgets(e)}distributeSelectedWidgets(e){this.selectionManager.distributeSelectedWidgets(e)}updateSettings(e){const n={},i={};Object.keys(e).forEach(o=>{o.startsWith("ai_api_key_")?n[o]=e[o]:i[o]=e[o]}),Object.keys(n).length&&Object.entries(n).forEach(([o,r])=>this.secrets.set(o,String(r??""))),this.preferences.update(i),e.device_name&&(this.project.state.deviceName=e.device_name),e.device_model&&(this.project.state.deviceModel=e.device_model),P(E.STATE_CHANGED),(e.device_model||e.orientation||e.custom_hardware)&&P(E.PAGE_CHANGED,{index:this.currentPageIndex,forceFocus:!0})}setDeviceName(e){this.project.state.deviceName=e,this.updateLayoutIndicator(),P(E.STATE_CHANGED)}setDeviceModel(e){this.project.state.deviceModel=e,this.updateLayoutIndicator(),P(E.STATE_CHANGED),P(E.PAGE_CHANGED,{index:this.currentPageIndex,forceFocus:!0})}setCurrentLayoutId(e){this.project.state.currentLayoutId=e,this.updateLayoutIndicator(),P(E.STATE_CHANGED)}setManualYamlOverride(e,n={}){this.project.setManualYamlOverride(e,n)}clearManualYamlOverride(e={}){this.project.clearManualYamlOverride(e)}updateLayoutIndicator(){const e=document.getElementById("currentLayoutName");e&&(e.textContent=this.project.deviceName||this.project.currentLayoutId||"Unknown")}setSnapEnabled(e){this.preferences.setSnapEnabled(e)}setShowGrid(e){this.preferences.setShowGrid(e)}setShowDebugGrid(e){this.preferences.setShowDebugGrid(e)}setShowRulers(e){this.preferences.setShowRulers(e)}setZoomLevel(e){this.editor.setZoomLevel(e)}setCustomHardware(e){this.widgetManager.setCustomHardware(e)}addWidget(e,n=null){this.widgetManager.addWidget(e,n)}updateWidget(e,n){this.widgetManager.updateWidget(e,n)}updateWidgets(e,n){this.widgetManager.updateWidgets(e,n)}updateWidgetsProps(e,n){this.widgetManager.updateWidgetsProps(e,n)}deleteWidget(e=null){this.widgetManager.deleteWidget(e)}moveWidgetToPage(e,n,i=null,o=null){return this.widgetManager.moveWidgetToPage(e,n,i,o)}copyWidget(e=null){this.widgetManager.copyWidget(e)}pasteWidget(){this.widgetManager.pasteWidget()}createDropShadow(e){this.widgetManager.createDropShadow(e)}clearCurrentPage(e=!1){return this.pageManager.clearCurrentPage(e)}recordHistory(){this.historyManager.recordHistory()}replaceHistoryBaseline(){this.historyManager.replaceHistoryBaseline()}undo(){this.historyManager.undo()}redo(){this.historyManager.redo()}setInternalFlag(e,n){const i=this.$raw||this;i[String(e)]=n}restoreSnapshot(e){this.historyManager.restoreSnapshot(e)}canUndo(){return this.historyManager.canUndo()}canRedo(){return this.historyManager.canRedo()}syncWidgetOrderWithHierarchy(){this.widgetManager.syncWidgetOrderWithHierarchy()}syncWidgetVisibilityWithMode(){this.widgetManager.syncWidgetVisibilityWithMode()}_isWidgetCompatibleWithMode(e,n){return this.widgetManager.isWidgetCompatibleWithMode(e,n)}_checkRenderingModeForWidget(e){this.widgetManager.checkRenderingModeForWidget(e)}}const bo=new vo,_o={set(t,e,n,i){return e==="snapEnabled"?(_.warn(`[StateProxy] Intercepted illegal write to '${String(e)}'. Automatically rerouting to setSnapEnabled().`),typeof t.setSnapEnabled=="function"&&t.setSnapEnabled(!!n),!0):(typeof e=="string"&&!["entityStates","_isRestoringHistory","isUndoRedoInProgress"].includes(e)&&typeof t[e]!="function"&&(_.warn(`[StateProxy] Illegal state mutation detected: AppState.${e} = ${String(n)}`),console.trace(`[StateProxy] Trace for illegal mutation of AppState.${e}`)),Reflect.set(t,e,n,i))}},p=new Proxy(bo,_o);class U{static getEffectiveDarkMode(){const n=p?.getCurrentPage?.()?.dark_mode;return n==="dark"?!0:n==="light"?!1:!!(p&&p.settings&&p.settings.dark_mode)}static getDefaultColor(){return U.getEffectiveDarkMode()?"white":"black"}static getDefaultBgColor(){return U.getEffectiveDarkMode()?"black":"white"}static getGridCellDefaults(){return{grid_cell_row_pos:null,grid_cell_column_pos:null,grid_cell_row_span:1,grid_cell_column_span:1,grid_cell_x_align:"STRETCH",grid_cell_y_align:"STRETCH"}}static isLvglWidget(e){return!!(e&&e.startsWith("lvgl_"))}static createWidget(e){const n=_e(),i=U.getDefaultBgColor(),o=U.getDefaultColor();let r={id:n,type:e,x:40,y:40,width:120,height:40,title:"",entity_id:"",locked:!1,props:{}};switch(e){case"nav_next_page":return r.props={title:"Next",color:"rgba(0, 128, 255, 0.2)",border_color:"#0080ff",nav_action:"next_page",icon:"F0142",icon_size:48},r.width=80,r.height=80,r;case"nav_previous_page":return r.props={title:"Previous",color:"rgba(0, 128, 255, 0.2)",border_color:"#0080ff",nav_action:"previous_page",icon:"F0141",icon_size:48},r.width=80,r.height=80,r;case"nav_reload_page":return r.props={title:"Reload",color:"rgba(0, 128, 255, 0.2)",border_color:"#0080ff",nav_action:"reload_page",icon:"F0450",icon_size:48},r.width=80,r.height=80,r}const s=q.get(e);return s&&s.defaults&&(r.props={...s.defaults},(r.props.color==="black"||r.props.color==="white")&&(r.props.color="theme_auto"),(r.props.text_color==="black"||r.props.text_color==="white")&&(r.props.text_color="theme_auto"),(r.props.bg_color==="black"||r.props.bg_color==="white")&&(r.props.bg_color=i),(r.props.background_color==="black"||r.props.background_color==="white")&&(r.props.background_color=i),(r.props.border_color==="black"||r.props.border_color==="white")&&(r.props.border_color=o),s.width&&(r.width=s.width),s.height&&(r.height=s.height),s.defaults.width&&(r.width=s.defaults.width),s.defaults.height&&(r.height=s.defaults.height),s.defaults.w&&(r.width=s.defaults.w),s.defaults.h&&(r.height=s.defaults.h)),U.isLvglWidget(e)&&(r.props={...U.getGridCellDefaults(),...r.props}),r}}let ke=null;class ca{constructor(){this.isOpen=!1,this.selectedIndex=0,this.filteredWidgets=[],this.allWidgets=[],this.modal=null,this.input=null,this.resultsContainer=null,ke=this,this.init()}init(){this.createModal(),this.bindEvents()}discoverWidgets(){this.allWidgets=[];const e=document.querySelectorAll(".widget-category .item[data-widget-type]");if(e.length===0){_.warn("[QuickSearch] No widgets found in palette");return}e.forEach(n=>{const i=n.getAttribute("data-widget-type"),o=n.querySelector(".label"),r=o?o.textContent.trim():i,s=n.closest(".widget-category"),a=s?s.querySelector(".category-name"):null,l=a?a.textContent.trim():"Widgets";this.allWidgets.push({type:i,label:r,category:l,searchText:`${r} ${i} ${l}`.toLowerCase()})}),_.log(`[QuickSearch] Discovered ${this.allWidgets.length} widgets`)}createModal(){this.modal=document.createElement("div"),this.modal.id="quick-search-modal",this.modal.className="quick-search-modal hidden",this.modal.innerHTML=`
    ...
    `;const a=p.getCanvasShape();(a==="round"||a==="circle")&&s.classList.add("round-display");const l=c=>{if(_.log("[Canvas] Add Page placeholder clicked"),c.stopPropagation(),c.preventDefault(),p.addPage()){const u=p.pages.length-1;e&&e.canvas&&(e.canvas.suppressNextFocus=!0),p.setCurrentPageIndex(u)}};s.addEventListener("mousedown",c=>c.stopPropagation()),s.addEventListener("click",l),r.appendChild(s),o&&r.appendChild(o),t.canvas.appendChild(r),wn(t)}class To{constructor(e){this.canvasInstance=e,this.topRuler=document.getElementById("rulerTop"),this.leftRuler=document.getElementById("rulerLeft"),this.container=document.querySelector(".canvas-rulers"),this.viewport=e.viewport,this.topCtx=null,this.leftCtx=null,this.indicators=null,this.init()}init(){!this.topRuler||!this.leftRuler||(this.topCtx=this.createRulerCanvas(this.topRuler),this.leftCtx=this.createRulerCanvas(this.leftRuler),this.update())}createRulerCanvas(e){const n=document.createElement("canvas");return e.appendChild(n),n.getContext("2d")}setIndicators(e){this.indicators=e,this.update()}update(){if(!p.showRulers){this.container&&(this.container.style.display="none"),this.viewport&&this.viewport.classList.remove("with-rulers");return}this.container&&(this.container.style.display="block"),this.viewport&&this.viewport.classList.add("with-rulers");const e=document.querySelector(".artboard-wrapper.active-page .artboard");if(!e||!this.topRuler||!this.leftRuler)return;const n=this.topRuler.getBoundingClientRect(),i=this.leftRuler.getBoundingClientRect(),o=e.getBoundingClientRect(),r=p.zoomLevel;this.drawHorizontal(n,o,r),this.drawVertical(i,o,r)}drawHorizontal(e,n,i){const o=this.topCtx;if(!o)return;const r=o.canvas,s=Tt();(r.width!==e.width*s||r.height!==e.height*s)&&(r.width=e.width*s,r.height=e.height*s,o.scale(s,s),r.style.width=e.width+"px",r.style.height=e.height+"px"),o.clearRect(0,0,e.width,e.height);const a=n.left-e.left;if(this.indicators){const d=a+this.indicators.x*i,u=(this.indicators.w||0)*i;o.fillStyle="hsla(var(--accent-h), 85%, 65%, 0.15)",o.fillRect(d,0,u,e.height),o.fillStyle="var(--accent)",o.fillRect(d,e.height-2,u,2)}o.strokeStyle="#4b5563",o.fillStyle="#9ca3af",o.font='9px "JetBrains Mono", monospace',o.lineWidth=1;const l=Math.floor(-a/i/10)*10,c=Math.ceil((e.width-a)/i/10)*10;for(let d=l;d<=c;d+=10){const u=a+d*i;if(u<0||u>e.width)continue;const g=d%100===0,h=d%50===0,m=g?12:h?8:4;o.beginPath(),o.moveTo(u,e.height),o.lineTo(u,e.height-m),o.stroke(),g&&o.fillText(d.toString(),u+2,10)}}drawVertical(e,n,i){const o=this.leftCtx;if(!o)return;const r=o.canvas,s=Tt();(r.width!==e.width*s||r.height!==e.height*s)&&(r.width=e.width*s,r.height=e.height*s,o.scale(s,s),r.style.width=e.width+"px",r.style.height=e.height+"px"),o.clearRect(0,0,e.width,e.height);const a=n.top-e.top;if(this.indicators){const d=a+this.indicators.y*i,u=(this.indicators.h||0)*i;o.fillStyle="hsla(var(--accent-h), 85%, 65%, 0.15)",o.fillRect(0,d,e.width,u),o.fillStyle="var(--accent)",o.fillRect(e.width-2,d,2,u)}o.strokeStyle="#4b5563",o.fillStyle="#9ca3af",o.font='9px "JetBrains Mono", monospace',o.lineWidth=1;const l=Math.floor(-a/i/10)*10,c=Math.ceil((e.height-a)/i/10)*10;for(let d=l;d<=c;d+=10){const u=a+d*i;if(u<0||u>e.height)continue;const g=d%100===0,h=d%50===0,m=g?12:h?8:4;o.beginPath(),o.moveTo(e.width,u),o.lineTo(e.width-m,u),o.stroke(),g&&(o.save(),o.translate(10,u+2),o.rotate(-Math.PI/2),o.fillText(d.toString(),0,0),o.restore())}}}function Mo(t){t.viewport&&(t.viewport.addEventListener("dragenter",e=>{t.dragState||(t.isExternalDragging=!0)}),t.viewport.addEventListener("dragover",e=>{e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect="copy"),t.dragState||(t.isExternalDragging=!0);const i=e.target.closest(".artboard-wrapper");document.querySelectorAll(".artboard-wrapper.drag-over").forEach(r=>{r!==i&&r.classList.remove("drag-over")}),i&&i.classList.add("drag-over");const o=e.target.closest(".add-page-placeholder");if(o)o.classList.add("drag-over");else{const r=document.querySelector(".add-page-placeholder.drag-over");r&&r.classList.remove("drag-over")}}),t.viewport.addEventListener("dragleave",e=>{(e.relatedTarget===null||!t.viewport.contains(e.relatedTarget))&&(t.isExternalDragging=!1,document.querySelectorAll(".artboard-wrapper.drag-over, .add-page-placeholder.drag-over").forEach(n=>{n.classList.remove("drag-over")}))}),t.viewport.addEventListener("drop",async e=>{e.preventDefault(),e.stopPropagation(),t.isExternalDragging=!1,document.querySelectorAll(".artboard-wrapper.drag-over, .add-page-placeholder.drag-over").forEach(u=>{u.classList.remove("drag-over")});const n=e.dataTransfer;if(!n)return;const i=n.getData("application/widget-type")||n.getData("text/plain");if(!i)return;const o=e.clientX,r=e.clientY;let s=e.target;s===t.viewport&&(s=document.elementFromPoint(o,r));const a=s instanceof HTMLElement?s.closest(".artboard-wrapper"):null,l=s instanceof HTMLElement?s.closest(".add-page-placeholder"):null;let c=-1,d=null;if(a instanceof HTMLElement){c=parseInt(a.dataset.index||"-1",10);const u=a.querySelector(".artboard");u&&(d=u.getBoundingClientRect())}else if(l instanceof HTMLElement)c=p.pages.length;else{c=p.currentPageIndex;const u=t.canvas.querySelector(`.artboard[data-index="${c}"]`);u&&(d=u.getBoundingClientRect())}_.log("[Canvas] Atomic drop capture - type:",i,"page:",c);try{const u=q.load(i);if(l){if(!p.addPage())return;c=p.pages.length-1,await new Promise(b=>setTimeout(b,50));const y=t.canvas.querySelector(`.artboard[data-index="${c}"]`);y&&(d=y.getBoundingClientRect())}await u;const g=U.createWidget(i);if(!g){_.error("[Canvas] WidgetFactory.createWidget returned null for type:",i);return}const h=p.zoomLevel,m=p.getCanvasDimensions();if(d){const f=(o-d.left)/h,y=(r-d.top)/h;g.x=Math.round(f-g.width/2),g.y=Math.round(y-g.height/2)}else _.warn("[Canvas] No targetRect, using fallback position"),g.x=40,g.y=40;g.x=Math.max(0,Math.min(m.width-g.width,g.x)),g.y=Math.max(0,Math.min(m.height-g.height,g.y)),t.suppressNextFocus=!0,p.addWidget(g,c),p.currentPageIndex!==c&&p.setCurrentPageIndex(c),p.selectWidget(g.id,!1),_.log(`[Canvas] Successfully added ${i} at (${g.x}, ${g.y})`)}catch(u){_.error("[Canvas] error creating widget from drop:",u)}}))}function Ao(t){t.viewport&&t.viewport.addEventListener("mousedown",e=>{if(e.button===1){e.preventDefault(),e.stopPropagation(),t.panState={startX:e.clientX,startY:e.clientY,startPanX:t.panX,startPanY:t.panY},t.viewport.style.cursor="grabbing",document.body.classList.add("panning-active");const n=o=>{if(t.panState){const r=o.clientX-t.panState.startX,s=o.clientY-t.panState.startY;t.panX=t.panState.startPanX+r,t.panY=t.panState.startPanY+s,ne(t)}},i=()=>{t.panState=null,t.viewport.style.cursor="auto",document.body.classList.remove("panning-active"),Y("mousemove",n),Y("mouseup",i)};G("mousemove",n),G("mouseup",i)}})}function Oo(t){const e=document.getElementById("zoomInBtn"),n=document.getElementById("zoomOutBtn"),i=document.getElementById("zoomResetBtn"),o=document.getElementById("gridToggleBtn"),r=document.getElementById("debugGridToggleBtn"),s=document.getElementById("rulersToggleBtn"),a=document.getElementById("editorGridOpacity");e&&e.addEventListener("click",()=>at(t)),n&&n.addEventListener("click",()=>lt(t)),i&&i.addEventListener("click",()=>We(t)),o&&(o.classList.toggle("active",!!p.showGrid),o.addEventListener("click",()=>{const l=!p.showGrid;p.setShowGrid(l),l&&(p.setShowDebugGrid(!1),r&&r.classList.remove("active")),o.classList.toggle("active",l),P(E.STATE_CHANGED)})),r&&(r.classList.toggle("active",!!p.showDebugGrid),r.addEventListener("click",()=>{const l=!p.showDebugGrid;p.setShowDebugGrid(l),l&&(p.setShowGrid(!1),o&&o.classList.remove("active")),r.classList.toggle("active",l),P(E.STATE_CHANGED)})),s&&(s.classList.toggle("active",!!p.showRulers),s.addEventListener("click",()=>{const l=!p.showRulers;p.setShowRulers(l),s.classList.toggle("active",l),_.log(`[Canvas] Rulers toggled: ${l}`)})),a&&a.addEventListener("input",l=>{const c=l.target;p.updateSettings({grid_opacity:parseInt(c.value,10)})}),t.canvasContainer&&t.canvasContainer.addEventListener("wheel",l=>{l.preventDefault(),Wt(l,t)},{passive:!1}),t.viewport&&t.viewport.addEventListener("wheel",l=>{l.preventDefault(),Wt(l,t)},{passive:!1}),document.addEventListener("keydown",l=>{l.ctrlKey&&(l.key==="+"||l.key==="=")?(l.preventDefault(),at(t)):l.ctrlKey&&l.key==="-"?(l.preventDefault(),lt(t)):l.ctrlKey&&l.key==="0"||l.ctrlKey&&l.key.toLowerCase()==="r"?(l.preventDefault(),We(t)):l.ctrlKey&&l.key.toLowerCase()==="g"&&(l.preventDefault(),l.shiftKey?p.ungroupSelection():p.groupSelection())})}function Wt(t,e){const n=p.zoomLevel;let i=0;if(t.ctrlKey)i=t.deltaY>0?-.02:.02;else if(t.deltaMode===0&&t.deltaX===0&&Math.abs(t.deltaY)>=50)i=t.deltaY>0?-.05:.05;else{e.panX-=t.deltaX,e.panY-=t.deltaY,ne(e);return}if(i===0)return;const o=Math.min(Math.max(n+i,.1),5);if(o===n)return;const r=e.viewport.getBoundingClientRect(),s=t.clientX-r.left,a=t.clientY-r.top,l=(s-e.panX)/n,c=(a-e.panY)/n;e.panX=s-l*o,e.panY=a-c*o,p.setZoomLevel(o),ne(e)}function at(t){kn(.05,t)}function lt(t){kn(-.05,t)}function kn(t,e){const n=p.zoomLevel,i=Math.min(Math.max(n+t,.1),5);if(i!==n){if(e&&e.viewport){const o=e.viewport.getBoundingClientRect(),r=o.width/2,s=o.height/2,a=(r-e.panX)/n,l=(s-e.panY)/n;e.panX=r-a*i,e.panY=s-l*i}p.setZoomLevel(i),e&&ne(e)}}function We(t){p.setZoomLevel(1),t.focusPage(p.currentPageIndex,!0)}function te(){document.querySelectorAll(".snap-guide").forEach(e=>e.remove())}function In(t,e,n){const i=n||(t?t.canvas:null);if(!i||typeof i.appendChild!="function")return;const o=document.createElement("div");o.className="snap-guide snap-guide-vertical",o.style.left=`${Math.round(e)}px`,i.appendChild(o)}function Pn(t,e,n){const i=n||(t?t.canvas:null);if(!i||typeof i.appendChild!="function")return;const o=document.createElement("div");o.className="snap-guide snap-guide-horizontal",o.style.top=`${Math.round(e)}px`,i.appendChild(o)}function Ln(t,e){const n=p.getCurrentPage(),i=[],o=[];if(i.push(0,e.width/2,e.width),o.push(0,e.height/2,e.height),n&&Array.isArray(n.widgets))for(const r of n.widgets){if(!r||r.id===t)continue;const s=r.x,a=r.x+(r.width||0),l=r.y,c=r.y+(r.height||0),d=s+(r.width||0)/2,u=l+(r.height||0)/2;i.push(s,d,a),o.push(l,u,c)}return{vertical:i,horizontal:o}}function Nt(t,e,n,i,o){const r=o||(t?t.canvas:null);if(!r)return;const s=document.createElement("div");s.className=`snap-guide distance-marker distance-marker-${i}`;let a,l,c,d,u;if(i==="h"){const h=e.x<n.x?e.x+e.w:n.x+n.w,m=e.x<n.x?n.x:e.x;if(a=h,l=Math.min(e.y+e.h/2,n.y+n.h/2),c=m-h,c<=0)return;u=Math.round(c),s.style.left=`${a}px`,s.style.top=`${l}px`,s.style.width=`${c}px`,s.style.height="1px";const f=document.createElement("div");f.className="distance-marker-h-tick-start";const y=document.createElement("div");y.className="distance-marker-h-tick-end",s.appendChild(f),s.appendChild(y)}else{const h=e.y<n.y?e.y+e.h:n.y+n.h,m=e.y<n.y?n.y:e.y;if(l=h,a=Math.min(e.x+e.w/2,n.x+n.w/2),d=m-h,d<=0)return;u=Math.round(d),s.style.left=`${a}px`,s.style.top=`${l}px`,s.style.width="1px",s.style.height=`${d}px`;const f=document.createElement("div");f.className="distance-marker-v-tick-start";const y=document.createElement("div");y.className="distance-marker-v-tick-end",s.appendChild(f),s.appendChild(y)}const g=document.createElement("div");g.className="distance-marker-label",g.textContent=String(u),s.appendChild(g),r.appendChild(s)}function bt(t,e,n,i,o,r,s,a=!1){if(!p.snapEnabled||o)return te(),{x:Math.round(n),y:Math.round(i)};const d=(p.getCurrentPage()?.widgets||[]).filter(S=>S.id!==e.id&&!S.hidden),u=Ln(e.id,r),g=e.width||0,h=e.height||0;let m=n,f=i,y=null,b=null;const v=[{val:n,apply:S=>m=S},{val:n+g/2,apply:S=>m=S-g/2},{val:n+g,apply:S=>m=S-g}];let x=le+1;for(const S of v)for(const I of u.vertical){const T=Math.abs(S.val-I);T<=le&&T<x&&(x=T,y=I,S.apply(I))}const w=[{val:i,apply:S=>f=S},{val:i+h/2,apply:S=>f=S-h/2},{val:i+h,apply:S=>f=S-h}];let k=le+1;for(const S of w)for(const I of u.horizontal){const T=Math.abs(S.val-I);T<=le&&T<k&&(k=T,b=I,S.apply(I))}const C={x:m,y:f,w:g,h};return te(),y!=null&&In(t,y,s),b!=null&&Pn(t,b,s),a&&d.forEach(S=>{const I={x:S.x,y:S.y,w:S.width,h:S.height};if(C.y<I.y+I.h&&C.y+C.h>I.y){const M=C.x<I.x?I.x-(C.x+C.w):C.x-(I.x+I.w);M>0&&M<150&&Nt(t,C,I,"h",s)}if(C.x<I.x+I.w&&C.x+C.w>I.x){const M=C.y<I.y?I.y-(C.y+C.h):C.y-(I.y+I.h);M>0&&M<150&&Nt(t,C,I,"v",s)}}),{x:Math.round(m),y:Math.round(f)}}function _t(t,e,n,i,o,r){const s=o.match(/^(\d+)x(\d+)$/);if(!s)return{x:t,y:e};const a=parseInt(s[1],10),l=parseInt(s[2],10),c=r.width/l,d=r.height/a,u=t+n/2,g=e+i/2,h=Math.round(u/c-.5),m=Math.round(g/d-.5),f=Math.max(0,Math.min(l-1,h)),y=Math.max(0,Math.min(a-1,m));return{x:Math.round(f*c),y:Math.round(y*d)}}function Tn(t){const e=p.getCurrentPage();if(!e||!e.layout)return;const n=e.layout.match(/^(\d+)x(\d+)$/);if(!n)return;const i=p.getWidgetById(t);if(!i)return;const o=parseInt(n[1],10),r=parseInt(n[2],10),s=p.getCanvasDimensions(),a=s.width/r,l=s.height/o,c=i.x+i.width/2,d=i.y+i.height/2,u=Math.floor(c/a),g=Math.floor(d/l),h=Math.max(0,Math.min(o-1,g)),m=Math.max(0,Math.min(r-1,u)),f={...i.props,grid_cell_row_pos:h,grid_cell_column_pos:m},y=Math.max(1,Math.round(i.height/l)),b=Math.max(1,Math.round(i.width/a));f.grid_cell_row_span=y,f.grid_cell_column_span=b,p.updateWidget(t,{props:f})}function Do(t){const e=p.getWidgetById(t);if(!e)return;const n=p.getCanvasDimensions(),i=p.getCurrentPage();let o;if(i?.layout)o=_t(e.x,e.y,e.width,e.height,i.layout,n);else{const r=p.snapEnabled;typeof p.setSnapEnabled=="function"&&p.setSnapEnabled(!0),o=bt({canvas:{querySelectorAll:()=>[]},canvasContainer:document.createElement("div")},e,e.x,e.y,!1,n),typeof p.setSnapEnabled=="function"&&p.setSnapEnabled(r)}o&&(p.updateWidget(t,{x:o.x,y:o.y}),Tn(t),p.recordHistory())}function Oe(t,e,n,i,o,r){if(!p.snapEnabled||i)return t;const s=Ln(n,o),a=e==="v"?s.vertical:s.horizontal;let l=le+1,c=t,d=null;for(const u of a){const g=Math.abs(t-u);g<=le&&g<l&&(l=g,c=u,d=u)}return d!==null&&(e==="v"?In({canvas:r},d,r):Pn({canvas:r},d,r)),c}class Ho{constructor(){this.active=!1,this.element=null,this.targetWidgetId=null,this.position={x:0,y:0},this.init()}init(){this.element||(this.element=document.createElement("div"),this.element.className="radial-menu",this.element.innerHTML=`
        ...
        transform: scale(${o});
        transition: none;
    `;const a=t.dragState?.id,l=r.find(m=>m.id===a)||r[0],c=e.find(m=>m.id===l?.id)||e[0],d=document.querySelector(`.widget[data-id="${c.id}"]`);if(!c||!d)return;const u=[],g=p.getCurrentPage();e.forEach(m=>{if(u.push(m),m.type==="group"){const y=(g?.widgets||[]).filter(b=>b.parentId===m.id);u.push(...y)}}),u.map(m=>{const f=document.querySelector(`.widget[data-id="${m.id}"]`);if(!f)return null;const y=f.closest(".artboard"),b=li(f);return b?{widget:m,className:(y?y.className:"artboard")+" ghost-context-sim",attrs:Array.from(f.attributes).map(v=>({name:v.name,value:v.value})),styleCssText:f.style.cssText,innerHTML:f.innerHTML,background:b.background,backgroundColor:b.backgroundColor,border:b.border,borderRadius:b.borderRadius}:null}).filter(m=>m!==null).forEach(m=>{const f=document.createElement("div");f.className=m.className,f.style.cssText=`
                position: absolute;
...
`.trim();try{let d="";o==="gemini"?d=await this.callGemini(r,s,a,c):o==="openai"?d=await this.callOpenAI(r,s,a,c):o==="openrouter"&&(d=await this.callOpenRouter(r,s,a,c));let u=d.trim();if(u.includes("```")){const y=u.match(/```(?:json)?\s*([\s\S]*?)\s*```/);y&&y[1]&&(u=y[1].trim())}const g=u.indexOf("["),h=u.indexOf("{");let m=-1,f=-1;g!==-1&&(h===-1||g<h)?(m=g,f=u.lastIndexOf("]")):h!==-1&&(m=h,f=u.lastIndexOf("}")),m!==-1&&f!==-1&&f>m&&(u=u.substring(m,f+1));try{const y=JSON.parse(u),b=Vt.validateResponse(y);if(!b.valid&&(_.warn("[AI] Validation failed:",b.errors),b.sanitized.length===0))throw new Error("AI returned invalid widget data: "+b.errors.join(", "));return b.sanitized}catch(y){_.warn("Fast JSON parse failed, trying repair...",y);try{const b=this.repairJson(u),v=JSON.parse(b),x=Vt.validateResponse(v);return x.valid||_.warn("[AI] Validation failed after repair:",x.errors),x.sanitized}catch(b){throw _.error("JSON repair failed:",b),new Error("AI returned malformed JSON (possibly truncated). Try a shorter prompt or a more powerful model.")}}}catch(d){throw _.error("AI processing failed:",d),d}}async callGemini(e,n,i,o){const r=`https://generativelanguage.googleapis.com/v1beta/models/${n}:generateContent?key=${e}`,s={contents:[{role:"user",parts:[{text:i+`
